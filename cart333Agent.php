    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".cart-qty-btn", function() {
            ...
            if (action === "increase") {
                ...
                // নতুন qty দিয়ে মোট মূল্য হিসাব
                let newTotal = 0;
                $.each(cart, function(pid, item) {
                    if (pid == id) {
                        newTotal += (item.qty + 1) * item.price; // বাড়ানো qty দিয়ে
                    } else {
                ...
                if (newTotal > memberBalance) {
                    Swal.fire({
                        ...
                        text: `আপনার ব্যালেন্স ${memberBalance} টাকা। মোট মূল্য ${newTotal} টাকা হবে, যা আপনার ব্যালেন্সের বেশি।`,
                        icon: "error",
                    });
                    return; // বাড়ানো যাবে না
                }
