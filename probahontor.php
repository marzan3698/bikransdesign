                    ...
                    <nav class="main-nav"
                        ...
                        <div class="box">
                            ...
                            <div class="box-text-wrap">
                                <div class="box-text" style="font-size: 18px;">চতুর্থ প্রজন্ম প্রবাহত্তর<br><span
                        ...
                        <?php
                            ...
                            $total = count($level4_ids);
                            $total_page = ceil($total / $per_page);

                            $start = ($page - 1) * $per_page;

                            $level4_ids_paged = array_slice($level4_ids, $start, $per_page);
                        ?>
                        <table class="table1">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                            <?php foreach ($level4_ids_paged as $id){ ?>
                            <tr>
                                <td><?= $sl++ ?></td>
