                ...
                <div class="page-content homepagecontent">
                    ...
                    <nav class="main-nav"
                        ...
                        <div style="display: flex;width: 96.5%; margin: auto;margin-top:10px !important">
                            ...
                            <?php }else{ ?>
                                <div style="width: 60%;border:1px solid #fff; text-align: center;padding:5px;color:#fff;font-size:16px" onclick="window.location.href='agent_features.php'">
                                    রেফারেন্স আইডি দিন 👉
                                </div>
                            <?php } ?>
                        ...
                        <div style="display: flex;width: 96.5%; margin: auto;margin-top:10px !important">
                            ...
                            <?php if(isset($_GET['username_id'])){ ?>    
                                <div style="width: 60%;border:1px solid #fff; text-align: center;padding:5px;color:#fff;font-size:16px" onclick="window.location.href='agent_create-order.php?username_id=<?php echo $_GET['username_id']; ?>'">
                        ...
                        <div style="display: flex;width: 96.5%; margin: auto;margin-top:10px !important">
                            ...
                            <div style="width: 60%;border:1px solid #fff; text-align: center;padding:5px;color:#fff;font-size:16px">
                                ...
                                if(isset($_GET['username_id'])){
                                    ...
                                    echo '<span style="cursor:pointer;" onclick="window.location.href=\'agent_order-summary2.php?order_id='.$orderId.'\'">ডেলিভারির ঠিকানা দিন 👉</span>';
                                }else{
