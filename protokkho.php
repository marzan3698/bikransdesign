                    ...
                    <nav class="main-nav"
                        ...
                        <div class="box">
                            <div class="box-text-wrap">
                                <div class="box-text" style="font-size: 18px;">প্রথম প্রজন্ম বীজস্তর<br><span
                                        style="font-size: 14px;">প্রত্যক্ষ
                                        সহযোগী তালিকা</span>
                                </div>
                            </div>
                        ...
                        <?php
                            ...
                            $total = count($level1_ids);
                            $total_page = ceil($total / $per_page);

                            $start = ($page - 1) * $per_page;

                            $level1_ids_paged = array_slice($level1_ids, $start, $per_page);
                        ?>
                        <table class="table1">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                            <?php foreach ($level1_ids_paged as $id){ ?>
                            <tr>
                                <td><?= $sl++ ?></td>
