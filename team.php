  ...
  <div data-page="team" class="page no-toolbar no-navbar">
      ...
      <div class="page_single layout_fullwidth_padding">
		  ...
		  <div class="swiper-container-team swiper-init" data-effect="slide" data-space-between="10" data-pagination=".swiper-pagination-team" data-slides-per-view="2">
			...
			<div class="swiper-wrapper">
			  ...
			  <a href="about.php" data-view=".view-main"><img src="images/avatar.jpg" alt="" title="" /></a><strong>John Doe</strong><span>CEO</span>
			  </div>
			  <div class="swiper-slide team-block">
			  <a href="about.php" data-view=".view-main"><img src="images/avatar2.jpg" alt="" title="" /></a><strong>Jack Aleck</strong><span>PROGRAMMER</span>
			  </div>
			  <div class="swiper-slide team-block">
			  <a href="about.php" data-view=".view-main"><img src="images/avatar3.jpg" alt="" title="" /></a><strong>Alexa Patterson</strong><span>MANAGER</span>
			  </div>
			  <div class="swiper-slide team-block">
			  <a href="about.php" data-view=".view-main"><img src="images/avatar4.jpg" alt="" title="" /></a><strong>Michael Sanderson</strong><span>ACCOUNTANT</span>
			  </div>
			  <div class="swiper-slide team-block">
			  <a href="about.php" data-view=".view-main"><img src="images/avatar.jpg" alt="" title="" /></a><strong>John Doe</strong><span>DESIGNER</span>
			  </div>
			</div>
   ...
   <div class="page_single layout_fullwidth_padding">  
		  <div class="swiper-container-team swiper-init" data-effect="slide" data-space-between="0" data-pagination=".swiper-pagination-teambigger" data-slides-per-view="1">
			...
			<div class="swiper-wrapper">
			  <div class="swiper-slide team-block">
			  <a href="about.php" data-view=".view-main"><img src="images/avatar.jpg" alt="" title="" /></a>
			  ...
			  <div class="swiper-slide team-block">
			  <a href="about.php" data-view=".view-main"><img src="images/avatar2.jpg" alt="" title="" /></a>
			  ...
			  <div class="swiper-slide team-block">
			  <a href="about.php" data-view=".view-main"><img src="images/avatar3.jpg" alt="" title="" /></a>
