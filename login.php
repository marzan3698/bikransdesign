...
<body>
    ...
    <div class="phone-wrapper">
        ...
        <div class="content">
            <h1>বিক্রান্স বিজনেস লগইন</h1>
            <form id="LoginForm" method="post" action="">
                <div class="field-label">BIKRANS ID</div>
                <div class="input-wrap">
                    <input name="username" type="text" placeholder="বিক্রান্স আইডি লিখুন">
                </div>
                <div class="field-label">PASSWORD</div>
                <div class="input-wrap">
                    <input name="password" type="password" placeholder="পাসওয়ার্ড লিখুন" id="pwdInput">
                ...
                <button name="submit" type="submit" class="btn-login">লগইন করুন</button>
            </form>
