                    ...
                    <nav class="main-nav"
                        ...
                        <div class="box">
                            ...
                            <div class="box-text-wrap">
                                <div class="box-text" style="font-size: 18px;">নবম প্রজন্ম<br><span
                        ...
                        <?php
                            ...
                            $total = count($level9_ids);
                            $total_page = ceil($total / $per_page);

                            $start = ($page - 1) * $per_page;

                            $level9_ids_paged = array_slice($level9_ids, $start, $per_page);
                        ?>
                        <table class="table1">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                            <?php foreach ($level9_ids_paged as $id){ ?>
                            <tr>
                                <td><?= $sl++ ?></td>
