                    ...
                    <nav class="main-nav"
                        ...
                        <div class="box">
                            <div class="box-text-wrap">
                                <div class="box-text" style="font-size: 18px;">সম্ভাব্য বিজনেস  <br> ডিস্ট্রিবিউটর ইনভাইট তালিকা
                                </div>
                            </div>
                        ...
                        <?php
                            if(isset($_POST['delete'])){
                                $id = $_POST['id'];
                                QB::table('distributor_invite')->where('id', $id)->delete();
                                echo '<div class="alert alert-danger">ইনভাইট ডিলেট সফল হয়েছে।</div>';
                            }
                        ?>
                        <?php
                            ...
                            // মোট ডাটা
                            $total = QB::table('distributor_invite')->count();
                            $totalPages = ceil($total / $limit);

                            // ডাটা আনো
                            $data = QB::table('distributor_invite')
                                ->orderBy('id', 'desc')
                        ...
                        <table class="table table-bordered table-striped table-hover" style="text-align: left;width:98%;margin:auto">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background: #0B2234">তথ্য</th>
                                ...
                                <?php foreach($data as $d){ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;">
                                            <?= $distributor ? $distributor->name : 'N/A'; ?><br>
                                            <?= $distributor ? $distributor->phone : 'N/A'; ?><br>
                                        </td>
                                        <td style="text-align: left;">
                                             ডিস্ট্রিবিউটর সাথে সাক্ষাৎ:
                                            <?php 
                                                if($d->plan_share == 1){
                                                    echo 'সরাসরি প্ল্যান শেয়ার';
                                                } elseif($d->plan_share == 2){
                                                    echo 'অনলাইন প্ল্যান শেয়ার';
                                                } elseif($d->plan_share == 3){
                                                    echo 'ভিডিও মাধ্যমে প্ল্যান শেয়ার';
                                                }
                                            ?> <br>
                                            ডিস্ট্রিবিউটর কে প্ল্যান শেয়ার দিন ও সময়:<?= date('d-m-Y', strtotime($d->date)); ?>
