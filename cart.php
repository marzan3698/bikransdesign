	...
	<div class="page_single layout_fullwidth_padding">	
         ...
         <div class="cartcontainer">            
            <div class="cart_item" id="cartitem1">
            	...
            	<div class="item_thumb"><a href="shop-item.php" class="close-panel"><img src="images/photos/photo1.jpg" alt="" title="" /></a></div>
                <div class="item_qnty">
            ...
            <div class="cart_item" id="cartitem2">
            	...
            	<div class="item_thumb"><a href="shop-item.php" class="close-panel"><img src="images/photos/photo2.jpg" alt="" title="" /></a></div>
                <div class="item_qnty">
                    <form id="myform" method="POST" action="#">
                        <label>QUANTITY</label>
            ...
            <div class="cart_item" id="cartitem3">
            	...
            	<div class="item_thumb"><a href="shop-item.php" class="close-panel"><img src="images/photos/photo3.jpg" alt="" title="" /></a></div>
                <div class="item_qnty">
                    <form id="myform" method="POST" action="#">
                        <label>QUANTITY</label>
              ...
              <a href="checkout.php" class="button_full btyellow">PROCEED TO CHECKOUT</a>           
