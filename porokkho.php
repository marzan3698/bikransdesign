                    ...
                    <nav class="main-nav"
                        ...
                        <div class="box">
                            ...
                            <div class="box-text-wrap">
                                <div class="box-text" style="font-size: 18px;">দ্বিতীয় প্রজন্ম বীজস্তর<br><span
                                        style="font-size: 14px;">পরোক্ষ্য
                                        সহযোগী তালিকা</span>
                                </div>
                            </div>
                        ...
                        <?php
                            ...
                            $total = count($level2_ids);
                            $total_page = ceil($total / $per_page);

                            $start = ($page - 1) * $per_page;

                            $level2_ids_paged = array_slice($level2_ids, $start, $per_page);
                        ?>
                        <table class="table1">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                            <?php foreach ($level2_ids_paged as $id){ ?>
                            <tr>
                                <td><?= $sl++ ?></td>
                                ...
                                <td>
                                    <?php
                                        ...
                                        echo count($refer);
                                        if(count($refer) >= 5){
                                            echo '<img src="https://cdn-icons-png.flaticon.com/128/5290/5290058.png" width="30px">';
                                        }
                                    ?>
                                </td>
                            </tr>
