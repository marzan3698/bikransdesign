                    ...
                    <nav class="main-nav"
                        ...
                        <div class="box" style="padding: 38px 10px;">
                            <div class="box-text-wrap">
                                <div class="box-text"><span style="color: #17D286;">নগদ</span> <br> <span
                                        style="color: #17D286;">ক্যাশ আউট</span>
                                </div>
                            </div>
                            <div class="box-img-wrap">
                                <img src="images/custom/13.svg" alt="" class="box-img" style="width: 150px;">
                            </div>
                        </div>
                        <?php
                            $account = QB::table('bank_info')->where('user_id', $_SESSION['user_id'])->where('account_type', 'nogod')->first();
                            if(!$account){
                        ?>
                        ...
                        <?php }else{ ?>
                            ...
                            <form action="nagad2.php" method="post">
