                              ...
                              $balance = $member->jfund_balance;
                                    ...
                                    */
                                    ...
                                    add_balance_agent_refer_agent($agent_sponsor12, $totalCommission, 1, $user_id);
                                        ...
                                        echo "<script>localStorage.removeItem('cart555');</script>";
                        ...
                        <form action="" method="post">
                            ...
                            <div class="date-wrapper2" style="gap: 1px;">
                                <h4 onclick="window.location.href='#'" style="background-color:#0B2234;color:#12D584">
                                    ব্যালেন্স: <?php echo $user = QB::table('member')->where('id', $_SESSION['user_id'])->first()->agent_balence; ?>
                                </h4>
                                <h4 onclick="window.location.href='#'" style="background-color:#0B2234;color:#12D584">
                                    রিপোর্ট দেখুন
                                </h4>
                            ...
                            <div class="date-wrapper2" style="gap: 1px;">
                                <h4 onclick="window.location.href='cart5.php'" style="background-color:#12D584;color:#fff">
                                    কার্টকৃত প্রোডাক্ট দেখুন
                                </h4>
                            </div>
                            <div class="date-wrapper2" style="gap: 1px;">
                                <input type="text" name="username" id="username" class="custom-input" placeholder="ইউজার আইডি দিন" required autocomplete="off"><br>
                            </div>
                            <span id="username_status" class="text-danger" style="font-weight: bold;text-align: center; margin-bottom: 10px; display: block;"></span>
                            ...
                            ?>
                                ...
                                <div class="product-row" data-id="<?= $product->id ?>" data-price="<?= $product->main_price ?>">
                                    ...
                                    <div class="product-info">
                                        <div class="product-title"><?= $product->name ?><?= $stock ?></div>
...
<script>
    $("#username").on("keyup", function() {
        ...
        $.ajax({
            url: "ajax/check_username2.php",
            method: "POST",
            data: { username: username },
            dataType: "json",
            success: function(response) {                
                if (response.exists) {
                    $("#username_status").text("রেফারেন্স আইডি সঠিক, নামঃ " + response.data.name);
                    $("#username_status").css("color", "green");
                } else {
                    $("#username_status").text("রেফারেন্স আইডি সঠিক নয়");
