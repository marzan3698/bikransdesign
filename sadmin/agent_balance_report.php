    ...
    <table class="table table-bordered">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                // Assuming QB::table is used for fetching the agent details (you can replace it with your own query method)
                $agent = QB::table('agent')->where('id', $row['agent_id'])->first();
        ...
        ?>
            <tr>
                <td><?php echo $sl; ?></td>
                <td>
                    <strong>Username :</strong> <?php echo $agent->agent_username; ?><br />
                    <strong>Fullname :</strong> <?php echo $agent->agent_name; ?>
                </td>
