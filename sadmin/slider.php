...
<body class="page-header-fixed ">
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner ">
            ...
            <div class="library-menu"> <span class="one">-</span> <span class="two">-</span> <span
                                ...
                                <div class="widgets-container">
                                    ...
                                    if (isset($_POST["submit"])) {
                                        ...
                                        if ($uploadOk == 0) {
                                            ...
                                            if (move_uploaded_file($_FILES["images"]["tmp_name"], $target_file)) {
                                                ...
                                                $stmt = $mysqli->prepare("INSERT INTO slider (images) VALUES (?)");
                                    ...
                                    <form action="" method="post" runat="server" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="imgInp" accept="image/*" name="images"
                                                class="password form-control m-t-xxs" type="file" />
                                            <hr />
                                            <img style="width: 200px; border-radius: 10px;" src="<?php echo LOGO; ?>"
                                                id="blah" src="#" alt="your image" />
                                        </div>

                                        <button name="submit" type="submit"
                                            class="btn aqua m-t-xs bottom15-xs">Submit</button>
                                    </form>
                                ...
                                <div class="widgets-container">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        if (isset($_GET['detele'])) {
                                            ...
                                            $file_id = $d_id;
                                            $stmt = $mysqli->prepare("SELECT images FROM slider WHERE id = ?");
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $sl++; ?></td>
                                                <td><img style="width: 50px; border-radius: 10px;"
                                                        src="<?php echo $row['images']; ?>" /></td>
                                                <td><a class="badge badge-warning">Edit</a> <a
                                                        onclick="alert('Are you Sure To Delete')"
                                                        href="?detele=<?php echo $row['id']; ?>"
