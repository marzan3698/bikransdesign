        ...
        <div class="page-content-wrapper animated fadeInRight">
            <div class="page-content">
                <div class="row wrapper border-bottom page-heading">
                    <div class="col-lg-12">
                        <h2> <i class="fas fa-unlock-alt"></i> Agent</h2>
                    </div>
                </div>
                            ...
                            <div class="ibox float-e-margins">
                                <div class="widgets-container">
                                    ...
                                    if (isset($_POST['change_password'])) {
                                        ...
                                        $stmt = $mysqli->prepare("UPDATE agent SET show_password=?, password = ? WHERE id = ?");
                                        if (!$stmt) {
								...
								$count_query = "SELECT COUNT(*) AS total FROM agent";
								...
								$query = "SELECT * FROM agent ORDER BY id DESC  LIMIT ?, ?";
								...
								<table class="table table-bordered">
									...
									?>
											<tr>
												...
												<td><?php echo htmlspecialchars($row['agent_username']); ?></td>
