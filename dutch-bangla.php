            ...
            <div data-page="index" class="page homepage" style="background-color: #0B2234!important;">
                <div class="page-content homepagecontent">
                    ...
                    <nav class="main-nav"
                        ...
                        <div class="box" style="padding: 25px 15px;">
                            <div class="box-text-wrap">
                                <div class="box-text"><span style="color: #17D286;">ডাচ বাংলা</span> <br> <span
                                        style="color: #17D286;">ক্যাশ আউট</span>
                                </div>
                            </div>
                            <div class="box-img-wrap">
                                <img src="images/custom/12.svg" alt="" class="box-img" style="width: 117px;">
                            </div>
                        </div>
                        <?php
                        ...
                        <div style="width: 93.5%; display: block; margin: auto; padding: 5px; color: #fff; border: 1px solid #12D584; margin-bottom: 10px;">
                            ...
                            <a href="javascript::void(0)" onclick="window.location.href='account-settings.php?dbbl'" style="color: #12D584;">প্রোফাইল আপডেট করুন</a>
                        </div>
                        <?php }else{ ?>
                            ...
                            <form action="dutch-bangla2.php" method="post">
