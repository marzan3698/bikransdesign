...
$order = QB::table('agent_order')->where('id', $_GET['order_id'])->first();
if (!$order) {
                ...
                <div class="page-content homepagecontent">
                    ...
                    <?php 
                            if(isset($_POST['update'])){
                                ...
                                if(!$division){
                                    echo '<div style="color:red;text-align:center">বিভাগ পূরণ করুন</div>';
                                }

                                if(!$district){
                                    echo '<div style="color:red;text-align:center">জেলা পূরণ করুন</div>';
                                }

                                if(!$upazilla){
                                    echo '<div style="color:red;text-align:center">উপজেলা পূরণ করুন</div>';
                                }
                                
                                if(!$receiver_name){
                                    echo '<div style="color:red;text-align:center">নাম পূরণ করুন</div>';
                                }

                                if(!$receiver_phone){
                                    echo '<div style="color:red;text-align:center">ফোন নম্বর দিন</div>';
                                }

                                QB::table('agent_order')->where('id', $orderId)->update([
                                    'division' => $division,
                                    'district' => $district,
                                    'upazilla' => $upazilla,
                                ...
                                if($check && $check->reference_status == 1){
                                    ...
                                    echo "<script>
                                        setTimeout(function(){
                                            window.location.href = 'order-summary5.php?order_id={$orderId}';
                                        }, 500);
                                    </script>";
                                }
                        ...
                        <form action="" method="post">
                            <div id="voucher">
                                ...
                                <?php 
                                    $orderItems = QB::table('agent_order_items')->where('order_id', $_GET['order_id'])->get();
                                    $sl = 1;
                                ?>
                                <div class="user-info">
