...
(function () {
  ...
  window.Framework7 = function (params) {
    ...
    app.params = {
      ...
      materialPreloaderSvg:
        '<svg xmlns="http://www.w3.org/2000/svg" height="75" width="75" viewbox="0 0 75 75"><circle cx="37.5" cy="37.5" r="33.5" stroke-width="8"/></svg>',
      ...
      materialRippleElements:
        ".ripple, a.link, a.item-link, .button, .modal-button, .tab-link, .label-radio, .label-checkbox, .actions-modal-button, a.searchbar-clear, a.floating-button, .floating-button > a, .speed-dial-buttons a",
      // Auto init
      init: true,
    };
    ...
    if (typeof app.params.statusbarOverlay !== "undefined") {
      if (app.params.statusbarOverlay)
    ...
    var View = function (selector, params) {
      var defaults = {
        ...
        uniqueHistoryIgnoreGetParameters:
          app.params.uniqueHistoryIgnoreGetParameters,
      ...
      if (params.dynamicNavbar && app.params.material)
      ...
      if (typeof selector !== "string") {
        ...
        selector =
          (container.attr("id") ? "#" + container.attr("id") : "") +
          (container.attr("class")
            ? "." +
              container.attr("class").replace(/ /g, ".").replace(".active", "")
            : "");
        view.selector = selector;
      }
      ...
      if (app.params.pushState && view.main) {
        if (pushStateRoot) {
          ...
          if (
            viewURL.indexOf(pushStateSeparator) >= 0 &&
            viewURL.indexOf(pushStateSeparator + "#") < 0
          )
            viewURL = viewURL.split(pushStateSeparator)[0];
        }
      }
      ...
      if (currentPageData) {
        ...
        if (
          view.params.domCache &&
          view.params.dynamicNavbar &&
          !currentPageData.navbarInnerContainer
        ) {
          currentPageData.navbarInnerContainer =
            view.initialNavbars[
              view.initialPages.indexOf(currentPageData.container)
            ];
        }
      ...
      view.handleTouchStart = function (e) {
        if (
          !allowViewTouchMove ||
          !view.params.swipeBackPage ||
          isTouched ||
          app.swipeoutOpenedEl ||
          !view.allowPageChange
        )
          return;
        isMoved = false;
        isTouched = true;
        ...
        dynamicNavbar =
          view.params.dynamicNavbar &&
          container.find(".navbar-inner").length > 1;
      };
      ...
      view.handleTouchMove = function (e) {
        ...
        if (!isMoved) {
          ...
          var target = $(e.target);
          var swipeout = target.hasClass("swipeout")
            ? target
            : target.parents(".swipeout");
          ...
          var notFromBorder =
            touchesStart.x - container.offset().left >
            view.params.swipeBackPageActiveArea;
          if (app.rtl) {
            notFromBorder =
              touchesStart.x <
          ...
          if (dynamicNavbar) {
            ...
            activeNavElements = activeNavbar.find(
              ".left, .center, .right, .subnavbar, .fading",
            );
            previousNavElements = previousNavbar.find(
              ".left, .center, .right, .subnavbar, .fading",
            );
            if (app.params.animateNavBackIcon) {
              activeNavBackIcon = activeNavbar.find(
                ".left.sliding .back .icon",
              );
              previousNavBackIcon = previousNavbar.find(
                ".left.sliding .back .icon",
              );
            }
          }
        ...
        // Touches diff
        touchesDiff =
          (pageX - touchesStart.x - view.params.swipeBackPageThreshold) *
          inverter;
        ...
        var previousPageTranslate =
          (touchesDiff / 5 - viewContainerWidth / 5) * inverter;
        ...
        previousPage.transform(
          "translate3d(" + previousPageTranslate + "px,0,0)",
        );
        ...
        if (dynamicNavbar) {
          ...
          for (i = 0; i < activeNavElements.length; i++) {
            ...
            if (el[0].className.indexOf("sliding") >= 0) {
              ...
              if (app.params.animateNavBackIcon) {
                if (
                  el[0].className.indexOf("left") >= 0 &&
                  activeNavBackIcon.length > 0
                ) {
                  activeNavBackIcon.transform(
                    "translate3d(" + -activeNavTranslate + "px,0,0)",
                  );
                }
              }
            }
          ...
          for (i = 0; i < previousNavElements.length; i++) {
            ...
            if (el[0].className.indexOf("sliding") >= 0) {
              var previousNavTranslate =
                el[0].f7NavbarLeftOffset * (1 - percentage);
              if (app.device.pixelRatio === 1)
              ...
              if (app.params.animateNavBackIcon) {
                if (
                  el[0].className.indexOf("left") >= 0 &&
                  previousNavBackIcon.length > 0
                ) {
                  previousNavBackIcon.transform(
                    "translate3d(" + -previousNavTranslate + "px,0,0)",
                  );
                }
              }
            }
      ...
      view.handleTouchEnd = function (e) {
        ...
        isMoved = false;
        if (touchesDiff === 0) {
          $([activePage[0], previousPage[0]])
            .transform("")
            .css({ opacity: "", boxShadow: "" });
          if (dynamicNavbar) {
      ...
      if (app.params.pushState && view.main) {
        ...
        if (pushStateRoot) {
          pushStateUrl = docLocation.split(
            app.params.pushStateRoot + pushStateSeparator,
          )[1];
        } else if (
          pushStateSeparator &&
          docLocation.indexOf(pushStateSeparator) >= 0 &&
          docLocation.indexOf(pushStateSeparator + "#") < 0
        ) {
          pushStateUrl = pushStateUrlSplit;
        }
        var pushStateAnimatePages = app.params.pushStateNoAnimation
          ? false
          : undefined;
        ...
        if (pushStateUrl) {
          if (
            pushStateUrl.indexOf("#") >= 0 &&
            view.params.domCache &&
            historyState &&
            historyState.pageName &&
            "viewIndex" in historyState
          ) {
            ...
            pushStateUrl.indexOf("#") >= 0 &&
            view.params.domCache &&
            view.initialPagesUrl.indexOf(pushStateUrl) >= 0
          ) {
            app.router.load(view, {
    ...
    app.getCurrentView = function (index) {
      ...
      if (appView.length > 0) {
        ...
        if (appView.length > 1) {
          ...
          if (currentViews.length > 0 && typeof index !== "undefined")
    ...
    app.navbarInitCallback = function (
      view,
      pageContainer,
      navbarContainer,
      navbarInnerContainer,
    ) {
      if (!navbarContainer && navbarInnerContainer)
        navbarContainer = $(navbarInnerContainer).parent(".navbar")[0];
      if (
        navbarInnerContainer.f7NavbarInitialized &&
        view &&
        !view.params.domCache
      )
        return;
      ...
      if (
        navbarInnerContainer.f7NavbarInitialized &&
        ((view && view.params.domCache) ||
          (!view &&
            $(navbarContainer).parents(
              ".popup, .popover, .login-screen, .modal, .actions-modal, .picker-modal",
            ).length > 0))
      ) {
        // Reinit Navbar
    ...
    app.navbarRemoveCallback = function (
      view,
      pageContainer,
      navbarContainer,
      navbarInnerContainer,
    ...
    app.initNavbarWithCallback = function (navbarContainer) {
      ...
      if (
        navbarContainer.parents(".navbar-through").length === 0 &&
        viewContainer.find(".navbar-through").length === 0
      )
        return;
      ...
      navbarContainer.find(".navbar-inner").each(function () {
        ...
        if ($(navbarInnerContainer).attr("data-page")) {
          // For dom cache
          pageContainer = viewContainer.find(
            '.page[data-page="' +
              $(navbarInnerContainer).attr("data-page") +
              '"]',
          )[0];
        }
        if (!pageContainer) {
          ...
          if (pages.length === 1) {
            ...
            viewContainer.find(".page").each(function () {
              if (
                this.f7PageData &&
                this.f7PageData.navbarInnerContainer === navbarInnerContainer
              ) {
                pageContainer = this;
              }
            });
    ...
    app.sizeNavbars = function (viewContainer) {
      ...
      navbarInner.each(function () {
        ...
        if (center.hasClass("sliding")) {
          ...
          center[0].f7NavbarRightOffset =
            (navbarWidth - currLeft - diff - centerWidth) * inverter;
          if (onLeft)
            center.transform(
              "translate3d(" + center[0].f7NavbarLeftOffset + "px, 0, 0)",
            );
        }
        if (!noLeft && left.hasClass("sliding")) {
          if (app.rtl) {
            left[0].f7NavbarLeftOffset =
              (-(navbarWidth - left[0].offsetWidth) / 2) * inverter;
            left[0].f7NavbarRightOffset = leftWidth * inverter;
          } else {
            left[0].f7NavbarLeftOffset = -leftWidth;
            left[0].f7NavbarRightOffset =
              (navbarWidth - left[0].offsetWidth) / 2;
          }
          if (onLeft)
            left.transform(
              "translate3d(" + left[0].f7NavbarLeftOffset + "px, 0, 0)",
            );
        }
        if (!noRight && right.hasClass("sliding")) {
          if (app.rtl) {
            right[0].f7NavbarLeftOffset = -rightWidth * inverter;
            right[0].f7NavbarRightOffset =
              ((navbarWidth - right[0].offsetWidth) / 2) * inverter;
          } else {
            right[0].f7NavbarLeftOffset =
              -(navbarWidth - right[0].offsetWidth) / 2;
            right[0].f7NavbarRightOffset = rightWidth;
          }
          if (onLeft)
            right.transform(
              "translate3d(" + right[0].f7NavbarLeftOffset + "px, 0, 0)",
            );
        }
    ...
    var Searchbar = function (container, params) {
      ...
      // Input
      s.input = s.params.input
        ? $(s.params.input)
        : s.container.find('input[type="search"]');
      s.clearButton = s.params.clearButton
        ? $(s.params.clearButton)
        : s.container.find(".searchbar-clear");
      s.cancelButton = s.params.cancelButton
        ? $(s.params.cancelButton)
        : s.container.find(".searchbar-cancel");
      ...
      if (!s.params.overlay) {
        s.overlay =
          s.pageContainer.length > 0
            ? s.pageContainer.find(".searchbar-overlay")
            : $(".searchbar-overlay");
      } else {
      ...
      if (!s.params.found) {
        s.found =
          s.pageContainer.length > 0
            ? s.pageContainer.find(".searchbar-found")
            : $(".searchbar-found");
      } else {
      ...
      if (!s.params.notFound) {
        s.notFound =
          s.pageContainer.length > 0
            ? s.pageContainer.find(".searchbar-not-found")
            : $(".searchbar-not-found");
      } else {
      ...
      s.setCancelButtonMargin = function () {
        ...
        s.cancelButton.css(
          cancelMarginProp,
          -s.cancelButton[0].offsetWidth + "px",
        );
      ...
      s.triggerEvent = function (eventName, callbackName, eventData) {
        ...
        if (callbackName && s.params[callbackName])
          s.params[callbackName](s, eventData);
      };
      ...
      s.enable = function () {
        function _enable() {
          if (
            (s.searchList.length || s.params.customSearch) &&
            !s.container.hasClass("searchbar-active")
          )
      ...
      s.disable = function () {
        ...
        if (s.searchList.length || s.params.customSearch)
      ...
      s.handleInput = function () {
        setTimeout(function () {
          ...
          if (
            (s.searchList.length > 0 || s.params.customSearch) &&
            (s.params.searchIn || s.isVirtualList)
          )
            s.search(value, true);
        }, 0);
      };
      ...
      s.search = function (query, internal) {
        ...
        if (query.length === 0) {
          ...
          if (s.searchList.length && s.container.hasClass("searchbar-active"))
            s.overlay.addClass("searchbar-overlay-active");
        } else {
        ...
        if (s.isVirtualList) {
          ...
          if (virtualList.params.searchAll) {
            foundItems =
              virtualList.params.searchAll(query, virtualList.items) || [];
          } else if (virtualList.params.searchByItem) {
            for (var i = 0; i < virtualList.items.length; i++) {
              if (
                virtualList.params.searchByItem(
                  query,
                  i,
                  virtualList.params.items[i],
                )
              ) {
                foundItems.push(i);
              }
          ...
          s.searchList
            ...
            .each(function (index, el) {
              ...
              el.find(s.params.searchIn).each(function () {
                ...
                if (s.params.removeDiacritics)
                  itemText = removeDiacritics(itemText);
              ...
              if (
                wordsMatch !== values.length &&
                !(s.params.ignore && el.is(s.params.ignore))
              ) {
            ...
            s.searchList
              ...
              .each(function () {
                ...
                for (var i = 0; i < nextElements.length; i++) {
                  ...
                  if (
                    nextEl.hasClass("list-group-title") ||
                    nextEl.hasClass("item-divider")
                  )
                    break;
    ...
    app.initSearchbar = function (container) {
      container = $(container);
      var searchbar = container.hasClass("searchbar")
        ? container
        : container.find(".searchbar");
    ...
    var Messagebar = function (container, params) {
      ...
      // Textarea
      m.textarea = m.params.textarea
        ? $(m.params.textarea)
        : m.container.find("textarea");
      ...
      m.sizeTextarea = function () {
        ...
        if (scrollHeight + diff > height) {
          ...
          var newBarHeight =
            m.initialBarHeight + (newAreaHeight - m.initialAreaHeight);
          var maxBarHeight =
            m.params.maxHeight ||
            m.container.parents(".view")[0].offsetHeight - 88;
          if (newBarHeight > maxBarHeight) {
            newBarHeight = parseInt(maxBarHeight, 10);
            newAreaHeight =
              newBarHeight - m.initialBarHeight + m.initialAreaHeight;
          }
          m.textarea.css("height", newAreaHeight + "px");
          m.container.css("height", newBarHeight + "px");
          var onBottom =
            m.pageContent[0].scrollTop ===
            m.pageContent[0].scrollHeight - m.pageContent[0].offsetHeight;
          if (m.pageContent.length > 0) {
            m.pageContent.css("padding-bottom", newBarHeight + "px");
            if (
              m.pageContent.find(".messages-new-first").length === 0 &&
              onBottom
            ) {
              m.pageContent.scrollTop(
                m.pageContent[0].scrollHeight - m.pageContent[0].offsetHeight,
              );
            }
          }
      ...
      m.attachEvents = function (destroy) {
        ...
        m.textarea[method](
          "change keydown keypress keyup paste cut",
          m.handleTextarea,
        );
      };
    ...
    app.initPageMessagebar = function (pageContainer) {
      ...
      var messagebar = pageContainer.hasClass("messagebar")
        ? pageContainer
        : pageContainer.find(".messagebar");
    ...
    app.get = function (url, view, ignoreCache, callback) {
      ...
      if (
        ...
        app.params.cacheIgnore.indexOf(_url) < 0
      ) {
        ...
        for (var i = 0; i < app.cache.length; i++) {
          if (app.cache[i].url === _url) {
            // Check expiration
            if (
              new Date().getTime() - app.cache[i].time <
              app.params.cacheDuration
            ) {
              // Load from cache
    ...
    app.onPage = function (callbackName, pageName, callback) {
      if (pageName && pageName.split(" ").length > 1) {
        ...
        for (var i = 0; i < pageNames.length; i++) {
          returnCallbacks.push(
            app.onPage(callbackName, pageNames[i], callback),
          );
        }
    ...
    var pageCallbacksNames =
      "beforeInit init reinit beforeAnimation afterAnimation back afterBack beforeRemove".split(
        " ",
      );
    ...
    app.pageInitCallback = function (view, params) {
      ...
      if (pageContainer.f7PageInitialized && view && !view.params.domCache)
        return;
      ...
      if (
        params.fromPage &&
        !params.fromPage.navbarInnerContainer &&
        params.oldNavbarInnerContainer
      ) {
        params.fromPage.navbarInnerContainer = params.oldNavbarInnerContainer;
      }

      if (
        pageContainer.f7PageInitialized &&
        ((view && view.params.domCache) ||
          (!view &&
            $(pageContainer).parents(
              ".popup, .popover, .login-screen, .modal, .actions-modal, .picker-modal",
            ).length > 0))
      ) {
        // Reinit Page
      ...
      if (app.params.onPageBeforeInit)
        app.params.onPageBeforeInit(app, pageData);
    ...
    app.pageRemoveCallback = function (view, pageContainer, position) {
      var pageContext;
      if (pageContainer.f7PageData)
        pageContext = pageContainer.f7PageData.context;
      // Page Data
      var pageData = {
        container: pageContainer,
        name: $(pageContainer).attr("data-page"),
        ...
        navbarInnerContainer:
          pageContainer.f7PageData &&
          pageContainer.f7PageData.navbarInnerContainer,
        from: position,
        context: pageContext,
      };
      // Before Init Callback
      app.pluginHook("pageBeforeRemove", pageData);
      if (app.params.onPageBeforeRemove)
        app.params.onPageBeforeRemove(app, pageData);
    ...
    app.pageBackCallback = function (callback, view, params) {
      ...
      if (callback === "after") {
        ...
        if (app.params.onPageAfterBack)
          app.params.onPageAfterBack(app, pageData);
    ...
    app.pageAnimCallback = function (callback, view, params) {
      ...
      if (callback === "after") {
        ...
        if (app.params.onPageAfterAnimation)
          app.params.onPageAfterAnimation(app, pageData);
      ...
      if (callback === "before") {
        ...
        if (
          !newPage.hasClass("no-navbar") &&
          (oldPage.hasClass("no-navbar") ||
            oldPage.hasClass("no-navbar-by-scroll"))
        ) {
          view.showNavbar();
        }
        ...
        if (
          !newPage.hasClass("no-toolbar") &&
          (oldPage.hasClass("no-toolbar") ||
            oldPage.hasClass("no-toolbar-by-scroll"))
        ) {
          view.showToolbar();
        }
        // Hide/show tabbar
        ...
        if (newPage.hasClass("no-tabbar") && !oldPage.hasClass("no-tabbar")) {
          ...
          if (tabBar.length === 0)
            tabBar = $(view.container)
              .parents("." + app.params.viewsClass)
              .find(".tabbar");
          app.hideToolbar(tabBar);
        }
        if (
          !newPage.hasClass("no-tabbar") &&
          (oldPage.hasClass("no-tabbar") ||
            oldPage.hasClass("no-tabbar-by-scroll"))
        ) {
          tabBar = $(view.container).find(".tabbar");
          if (tabBar.length === 0)
            tabBar = $(view.container)
        ...
        if (app.params.onPageBeforeAnimation)
          app.params.onPageBeforeAnimation(app, pageData);
    ...
    app.initPage = function (pageContainer) {
      ...
      if (app.sizeNavbars)
        app.sizeNavbars(pageContainer.parents("." + app.params.viewClass)[0]);
      // Init messages
      ...
      if (app.initPageResizableTextarea)
        app.initPageResizableTextarea(pageContainer);
      // Init Material Preloader
      if (app.params.material && app.initPageMaterialPreloader)
        app.initPageMaterialPreloader(pageContainer);
      // Init Material Inputs
      if (app.params.material && app.initPageMaterialInputs)
        app.initPageMaterialInputs(pageContainer);
      // Init Material Tabbar
      if (app.params.material && app.initPageMaterialTabbar)
    ...
    app.router = {
      ...
      findElement: function (selector, container, view, notCached) {
        ...
        if (found.length > 1) {
          ...
          if (found.length > 1) {
            ...
            found = container.find(
              "." + app.params.viewMainClass + " " + selector,
            );
          }
        }
        if (found.length === 1) return found;
          ...
          if (!notCached)
            found = app.router.findElement(selector, container, view, true);
      ...
      animatePages: function (leftPage, rightPage, direction, view) {
        ...
        if (direction === "to-left") {
          leftPage
            ...
            .addClass("pt-page-moveToBottomEasing pt-page-ontop");
      ...
      prepareNavbar: function (
        ...
        $(newNavbarInner)
          ...
          .each(function () {
            var sliding = $(this);
            var slidingOffset =
              newNavbarPosition === "right"
                ? this.f7NavbarRightOffset
                : this.f7NavbarLeftOffset;

            if (app.params.animateNavBackIcon) {
              if (
                sliding.hasClass("left") &&
                sliding.find(".back .icon").length > 0
              ) {
                sliding
                  .find(".back .icon")
                  .transform("translate3d(" + -slidingOffset + "px,0,0)");
              }
              if (
                newNavbarPosition === "left" &&
                sliding.hasClass("center") &&
                $(oldNavbarInner).find(".left .back .icon ~ span").length > 0
              ) {
                slidingOffset +=
                  $(oldNavbarInner).find(".left .back span")[0].offsetLeft;
              }
            }
      ...
      animateNavbars: function (
        ...
        if (direction === "to-left") {
          rightNavbarInner
            .removeClass(removeClasses)
            .addClass("navbar-from-right-to-center");
          ...
          leftNavbarInner
            .removeClass(removeClasses)
            .addClass("navbar-from-center-to-left");
          leftNavbarInner.find(".sliding").each(function () {
            ...
            if (app.params.animateNavBackIcon) {
              if (
                sliding.hasClass("center") &&
                rightNavbarInner.find(".sliding.left .back .icon").length > 0
              ) {
                rightText = rightNavbarInner.find(".sliding.left .back span");
                if (rightText.length > 0)
                  this.f7NavbarLeftOffset += rightText[0].offsetLeft;
              }
              if (
                sliding.hasClass("left") &&
                sliding.find(".back .icon").length > 0
                ...
                sliding
                  .find(".back .icon")
                  .transform(
                    "translate3d(" + -this.f7NavbarLeftOffset + "px,0,0)",
                  );
              }
            }
            sliding.transform(
        ...
        if (direction === "to-right") {
          leftNavbarInner
            .removeClass(removeClasses)
            .addClass("navbar-from-left-to-center");
          leftNavbarInner.find(".sliding").each(function () {
            var sliding = $(this);
            sliding.transform("translate3d(0px,0,0)");
            if (app.params.animateNavBackIcon) {
          ...
          rightNavbarInner
            .removeClass(removeClasses)
            .addClass("navbar-from-center-to-right");
          rightNavbarInner.find(".sliding").each(function () {
            var sliding = $(this);
            if (app.params.animateNavBackIcon) {
              if (
      ...
      preroute: function (view, options) {
        ...
        if (
          (app.params.preroute &&
            app.params.preroute(view, options) === false) ||
          (view &&
            view.params.preroute &&
            view.params.preroute(view, options) === false)
        ) {
          return true;
        } else {
          return false;
      ...
      template7Render: function (view, options) {
        ...
        if (typeof content === "string") {
          if (url) {
            if (app.template7Cache[url] && !options.ignoreCache)
              t7_template = t7.cache[url];
            else {
        ...
        if (context) t7_ctx = context;
          ...
          if (!t7_ctx && template && t7.templates) {
            ...
            for (var templateName in t7.templates) {
              if (t7.templates[templateName] === template)
                t7_ctx = t7.data[templateName];
            }
          }
          if (!t7_ctx) t7_ctx = {};
        }
    ...
    app.router._load = function (view, options) {
      ...
      if (typeof animatePages === "undefined")
        animatePages = view.params.animatePages;
      ...
      if (
        (app.params.template7Pages && typeof content === "string") ||
        template
      ) {
      ...
      // Reload position
      reloadPosition =
        options.reload && (options.reloadPrevious ? "left" : "center");

      // Find new page
      if (pageName)
        newPage = pagesContainer.find('.page[data-page="' + pageName + '"]');
      else {
        newPage = app.router.findElement(
          ".page",
          app.router.temporaryDom,
          view,
        );
      }
      ...
      if (
        !newPage ||
        newPage.length === 0 ||
        (pageName && view.activePage && view.activePage.name === pageName)
      ) {
        view.allowPageChange = true;
        return;
      }
      ...
      newPage.addClass(
        options.reload ? "page-on-" + reloadPosition : "page-on-right",
      );
      ...
      if (view.params.dynamicNavbar) {
        ...
        // Find navbar
        if (pageName) {
          newNavbarInner = viewContainer.find(
            '.navbar-inner[data-page="' + pageName + '"]',
          );
        } else {
          newNavbarInner = app.router.findElement(
            ".navbar-inner",
            app.router.temporaryDom,
            view,
          );
      ...
      if (dynamicNavbar) {
        newNavbarInner.addClass(
          options.reload ? "navbar-on-" + reloadPosition : "navbar-on-right",
        );
      ...
      if (!url) {
        ...
        if (isDynamicPage)
          url =
            "#" +
            app.params.dynamicPageUrl
              .replace(/{{name}}/g, newPageName)
              .replace(
                /{{index}}/g,
                view.history.length - (options.reload ? 1 : 0),
              );
      ...
      if (app.params.pushState && !options.reloadPrevious && view.main) {
        ...
        if (pushState) {
          if (!isDynamicPage && !pageName) {
            history[method](
              { url: url, viewIndex: app.views.indexOf(view) },
              "",
      ...
      if (options.reload) {
        var lastUrl =
          view.history[view.history.length - (options.reloadPrevious ? 2 : 1)];
        if (
          lastUrl &&
          lastUrl.indexOf("#") === 0 &&
      ...
      if (options.reload) {
        if (
          view.params.domCache &&
          view.initialPages.indexOf(oldPage[0]) >= 0
        ) {
      ...
      app.pageInitCallback(view, {
        ...
        navbarInnerContainer: dynamicNavbar
          ? newNavbarInner && newNavbarInner[0]
          : undefined,
        oldNavbarInnerContainer: dynamicNavbar
          ? oldNavbarInner && oldNavbarInner[0]
          : undefined,
      ...
      if (dynamicNavbar) {
        app.navbarInitCallback(
          ...
          newNavbarInner[0],
          url,
          options.reload ? reloadPosition : "right",
        );
      }
      ...
      function afterAnimation() {
        ...
        oldPage
          .removeClass("pt-page-moveToBottomEasing pt-page-ontop")
          .addClass("page-on-left");
        if (dynamicNavbar) {
          newNavbarInner
            .removeClass(
              "navbar-from-right-to-center navbar-on-left navbar-on-right",
            )
            .addClass("navbar-on-center");
          oldNavbarInner
            .removeClass(
              "navbar-from-center-to-left navbar-on-center navbar-on-right",
            )
            .addClass("navbar-on-left");
        }
        app.pageAnimCallback("after", view, {
          pageContainer: newPage[0],
          url: url,
        ...
        if (!(view.params.swipeBackPage || view.params.preloadPreviousPage)) {
          if (view.params.domCache) {
            ...
            if (
              !(
                url.indexOf("#") === 0 &&
                newPage.attr("data-page").indexOf("smart-select-") === 0
              )
            ) {
    ...
    app.router._back = function (view, options) {
      ...
      function setPages() {
        ...
        if (force) {
          ...
          if (dynamicNavbar)
            navbarToRemove = $(
              (pageToRemove[0] && pageToRemove[0].f7RelatedNavbar) ||
                navbarInners[navbarInners.length - 2],
            );
          if (
            view.params.domCache &&
            view.initialPages.indexOf(pageToRemove[0]) >= 0
          ) {
            if (pageToRemove.length && pageToRemove[0] !== newPage[0])
              pageToRemove.addClass("cached");
            if (
              dynamicNavbar &&
              navbarToRemove.length &&
              navbarToRemove[0] !== newNavbarInner[0]
            ) {
        ...
        if (view.params.domCache) {
          if (oldPage[0] === newPage[0]) {
            ...
            if (oldPage.length === 0 && view.activePage)
              oldPage = $(view.activePage.container);
          }
        }
        ...
        if (dynamicNavbar && !oldNavbarInner) {
          ...
          if (view.params.domCache) {
            if (oldNavbarInner[0] === newNavbarInner[0]) {
              oldNavbarInner = navbar.children(
                ".navbar-inner.navbar-on-center:not(.cached)",
              );
            }
            if (oldNavbarInner.length === 0) {
              oldNavbarInner = navbar.children(
                '.navbar-inner[data-page="' + oldPage.attr("data-page") + '"]',
              );
            }
          }
          if (
            oldNavbarInner.length === 0 ||
            newNavbarInner[0] === oldNavbarInner[0]
          )
            dynamicNavbar = false;
        }
        ...
        if (
          dynamicNavbar &&
          newNavbarInner.hasClass("navbar-on-left") &&
          animatePages
        ) {
      ...
      if (pagesInView.length > 1 && !force) {
        ...
        if (view.params.dynamicNavbar) {
          ...
          if (
            newNavbarInner.length === 0 ||
            oldNavbarInner.length === 0 ||
            oldNavbarInner[0] === newNavbarInner[0]
          ) {
            dynamicNavbar = false;
          }
        }
    ...
    app.router.afterBack = function (view, oldPage, newPage) {
      ...
      if (view.params.dynamicNavbar) {
        ...
        if (
          view.params.domCache &&
          view.initialNavbars.indexOf(oldNavbar[0]) >= 0
        ) {
          oldNavbar
        ...
        newNavbar = $(inners[0])
          .removeClass("navbar-on-left navbar-from-left-to-center")
          .addClass("navbar-on-center");
      }
      ...
      if (view.params.domCache) {
        $(view.container)
          ...
          .each(function () {
            ...
            if (
              pageUrl &&
              view.history.indexOf(pageUrl) < 0 &&
              view.initialPages.indexOf(this) < 0
            ) {
              ...
              if (page[0].f7RelatedNavbar && view.params.dynamicNavbar)
                app.navbarRemoveCallback(
                  ...
                  page[0],
                  undefined,
                  page[0].f7RelatedNavbar,
                );
              page.remove();
              if (page[0].f7RelatedNavbar && view.params.dynamicNavbar)
                $(page[0].f7RelatedNavbar).remove();
            }
          });
      }
      ...
      if (view.params.preloadPreviousPage) {
        if (view.params.domCache && view.history.length > 1) {
          ...
          if (preloadUrl && view.pagesCache[preloadUrl]) {
            // Load by page name
            previousPage = $(view.container).find(
              '.page[data-page="' + view.pagesCache[preloadUrl] + '"]',
            );
            if (previousPage.next(".page")[0] !== newPage[0])
              previousPage.insertBefore(newPage);
            if (newNavbar) {
              previousNavbar = $(view.container).find(
                '.navbar-inner[data-page="' +
                  view.pagesCache[preloadUrl] +
                  '"]',
              );
              if (!previousNavbar || previousNavbar.length === 0)
                previousNavbar = newNavbar.prev(".navbar-inner.cached");
              if (previousNavbar.next(".navbar-inner")[0] !== newNavbar[0])
          ...
          if (previousPage && previousPage.length > 0)
            previousPage
              .removeClass("cached page-on-right page-on-center")
              .addClass("page-on-left");
          if (previousNavbar && previousNavbar.length > 0)
            previousNavbar
              .removeClass("cached navbar-on-right navbar-on-center")
              .addClass("navbar-on-left");
        } else {
    ...
    app.modal = function (params) {
      ...
      if (app.params.modalTemplate) {
        if (!app._compiledTemplates.modal)
          app._compiledTemplates.modal = t7.compile(app.params.modalTemplate);
        ...
        if (params.buttons && params.buttons.length > 0) {
          for (var i = 0; i < params.buttons.length; i++) {
            buttonsHTML +=
              ...
              (params.buttons[i].bold ? " modal-button-bold" : "") +
              '">' +
              params.buttons[i].text +
              "</span>";
          }
        }
        ...
        var textHTML = params.text
          ? '<div class="modal-text">' + params.text + "</div>"
          : "";
        ...
        var noButtons =
          !params.buttons || params.buttons.length === 0
            ? "modal-no-buttons"
            : "";
        var verticalButtons = params.verticalButtons
          ? "modal-buttons-vertical"
          : "";
        var modalButtonsHTML =
          params.buttons && params.buttons.length > 0
            ? '<div class="modal-buttons modal-buttons-' +
    ...
    app.prompt = function (text, title, callbackOk, callbackCancel) {
      ...
      return app.modal({
        ...
        title: typeof title === "undefined" ? app.params.modalTitle : title,
        afterText:
          '<div class="input-field"><input type="text" class="modal-text-input"></div>',
        buttons: [
          {
    ...
    app.modalLogin = function (text, title, callbackOk, callbackCancel) {
      ...
      return app.modal({
        ...
        title: typeof title === "undefined" ? app.params.modalTitle : title,
        afterText:
          '<div class="input-field modal-input-double"><input type="text" name="modal-username" placeholder="' +
          app.params.modalUsernamePlaceholder +
          '" class="modal-text-input"></div><div class="input-field modal-input-double"><input type="password" name="modal-password" placeholder="' +
          app.params.modalPasswordPlaceholder +
    ...
    app.actions = function (target, params) {
      ...
      if (toPopover) {
        var actionsToPopoverTemplate =
          app.params.modalActionsToPopoverTemplate ||
        ...
        if (!app._compiledTemplates.actionsToPopover) {
          app._compiledTemplates.actionsToPopover = t7.compile(
            actionsToPopoverTemplate,
          );
        }
        ...
        if (app.params.modalActionsTemplate) {
          if (!app._compiledTemplates.actions)
            app._compiledTemplates.actions = t7.compile(
              app.params.modalActionsTemplate,
            );
          ...
          for (var i = 0; i < params.length; i++) {
            for (var j = 0; j < params[i].length; j++) {
              ...
              buttonsHTML +=
                '<div class="' + buttonClass + '">' + button.text + "</div>";
      ...
      groups.each(function (index, el) {
        ...
        $(el)
          ...
          .each(function (index, el) {
            ...
            if (toPopover && $(el).find(buttonSelector).length > 0)
              clickTarget = $(el).find(buttonSelector);
    ...
    app.popover = function (modal, target, removeOnClose) {
      ...
      function sizePopover() {
        ...
        if (material) {
          ...
          if (
            target.hasClass("floating-button-to-popover") &&
            !modal.hasClass("modal-in")
          ) {
            ...
            var diffX =
              ...
              diffY =
                modalTop +
                modalHeight / 2 -
                (targetOffset.top + targetHeight / 2);
            target
                ...
                target
                  ...
                  .transform(
                    "translate3d(" +
                      ...
                      diffY +
                      "px,0) scale(" +
                      modalWidth / targetWidth +
                      ", " +
                      modalHeight / targetHeight +
                      ")",
                  );
              });
            ...
            modal.once("close", function () {
              target
                .removeClass(
                  "floating-button-to-popover-in floating-button-to-popover-scale",
                )
          ...
          if (modalPosition === "top" || modalPosition === "bottom") {
            ...
            modalAngleLeft = Math.max(
              Math.min(modalAngleLeft, modalWidth - modalAngleSize * 2 - 13),
              13,
            );
            ...
            modalAngleTop = Math.max(
              Math.min(modalAngleTop, modalHeight - modalAngleSize * 2 - 13),
              13,
            );
    ...
    app.pickerModal = function (modal, removeOnClose) {
      ...
      if (modal.length === 0) return false;
      if (
        $(".picker-modal.modal-in:not(.modal-out)").length > 0 &&
        !modal.hasClass("modal-in")
      ) {
    ...
    app.loginScreen = function (modal) {
      ...
      if (modal.length === 0) return false;
      if (
        $(".login-screen.modal-in:not(.modal-out)").length > 0 &&
        !modal.hasClass("modal-in")
      ) {
    ...
    app.openModal = function (modal) {
      ...
      if (
        $(".modal.modal-in:not(.modal-out)").length &&
        app.params.modalStack &&
        isModal
      ) {
      ...
      if (app.params.material && isPickerModal && overlay)
        overlay.addClass("modal-overlay-visible");
      modal
    ...
    app.closeModal = function (modal) {
      ...
      if (isPopup) overlay = $(".popup-overlay");
        ...
        if (isPickerModal && app.params.material)
          overlay = $(".picker-modal-overlay");
    ...
    app.setProgressbar = function (container, progress, speed) {
      ...
      if (
        ...
        progressbar.hasClass("progressbar-infinite")
      )
        return;
    ...
    app.showProgressbar = function (container, progress, color) {
      ...
      if (
        ...
        parseFloat(progress) !== progress * 1
      ) {
        color = progress;
        progress = undefined;
      }
      ...
      if (container.hasClass("progressbar")) progressbar = container;
        ...
        progressbar = container.children(
        ...
        if (progressbar.length === 0) {
          ...
          if (typeof progress !== "undefined") {
            // Determined
            progressbar = $(
              '<span class="progressbar progressbar-in' +
                (color ? " color-" + color : "") +
                '"><span></span></span>',
            );
          } else {
            // Infinite
            progressbar = $(
              '<span class="progressbar-infinite progressbar-in' +
                (color ? " color-" + color : "") +
                '"></span>',
            );
          }
    ...
    app.hideProgressbar = function (container) {
      ...
      if (
        progressbar.length === 0 ||
        !progressbar.hasClass("progressbar-in") ||
        progressbar.hasClass("progressbar-out")
      )
        return;
      progressbar
    ...
    app.initPageProgressbar = function (pageContainer) {
      ...
      pageContainer.find(".progressbar").each(function () {
        ...
        if (p.attr("data-progress"))
          app.setProgressbar(p, p.attr("data-progress"));
      });
    };
    ...
    app.openPanel = function (panelPosition) {
      ...
      var transitionEndTarget =
        effect === "reveal" ? $("." + app.params.viewsClass) : panel;
    ...
    app.closePanel = function () {
      ...
      var transitionEndTarget =
        effect === "reveal" ? $("." + app.params.viewsClass) : activePanel;
      ...
      $("body")
        ...
        .removeClass("with-panel-" + panelPosition + "-" + effect);
    };
    /*======================================================
        ************   Swipe panels   ************
        ======================================================*/
    app.initSwipePanels = function () {
      ...
      function handleTouchStart(e) {
        if (
          !app.allowPanelOpen ||
          (!app.params.swipePanel && !app.params.swipePanelOnlyClose) ||
          isTouched
        )
          return;
        ...
        if (
          !(
            app.params.swipePanelCloseOpposite || app.params.swipePanelOnlyClose
          )
        ) {
        ...
        touchesStart.y =
          e.type === "touchstart" ? e.targetTouches[0].pageY : e.pageY;
        if (
          app.params.swipePanelCloseOpposite ||
          app.params.swipePanelOnlyClose
        ) {
        ...
        if (app.params.swipePanelActiveArea && !opened) {
          ...
          if (side === "right") {
            if (
              touchesStart.x <
              window.innerWidth - app.params.swipePanelActiveArea
            )
              return;
          }
        }
      ...
      function handleTouchMove(e) {
        ...
        if (effect === "reveal") {
          ...
          app.pluginHook(
            "swipePanelSetTransform",
            views[0],
            panel[0],
            Math.abs(translate / panelWidth),
          );
        } else {
    ...
    app.initImagesLazyLoad = function (pageContainer) {
      ...
      if (app.params.imagesLazyLoadPlaceholder !== false)
    ...
    var Messages = function (container, params) {
      ...
      // Auto Layout
      m.layout = function () {
        if (!m.container.hasClass("messages-auto-layout"))
          m.container.addClass("messages-auto-layout");
        m.container.find(".message").each(function () {
          var message = $(this);
          if (message.find(".message-text img").length > 0)
            message.addClass("message-pic");
          if (message.find(".message-avatar").length > 0)
            message.addClass("message-with-avatar");
        });
        m.container.find(".message").each(function () {
          var message = $(this);
          ...
          if (
            prev.length > 0 &&
            prev.find(".message-name").length > 0 &&
            message.find(".message-name").length > 0
          ) {
            if (
              prev.find(".message-name").text() !==
              message.find(".message-name").text()
            ) {
      ...
      m.addMessages = function (newMessages, method, animate) {
        ...
        if (method === "prepend") {
          m.pageContent[0].scrollTop =
            scrollBefore + (m.pageContent[0].scrollHeight - heightBefore);
        }
        if (
          (method === "append" && !m.params.newMessagesFirst) ||
          (method === "prepend" && m.params.newMessagesFirst)
        ) {
        ...
        if (newMessages.length === 1) {
          ...
          if (method === "append") {
            for (
              i = messages.length - newMessages.length;
              i < messages.length;
              i++
            ) {
      ...
      m.scrollMessages = function (duration, scrollTop) {
        ...
        if (typeof scrollTop !== "undefined") newScroll = scrollTop;
          ...
          newScroll = m.params.newMessagesFirst
            ? 0
            : m.pageContent[0].scrollHeight - m.pageContent[0].offsetHeight;
    ...
    app.initSwipeout = function (swipeoutEl) {
        ...
        if (app.swipeoutOpenedEl) {
          ...
          if (
            !(
              ...
              target.parents(".actions-modal.modal-in, .modal.modal-in")
                .length > 0
            )
          ) {
      ...
      function handleTouchMove(e) {
        ...
        if (!isMoved) {
          ...
          actionsLeftWidth =
            ...
            overswipeLeftButton =
              null;
          noFoldLeft =
            actionsLeft.hasClass("swipeout-actions-no-fold") ||
            app.params.swipeoutActionsNoFold;
          noFoldRight =
            actionsRight.hasClass("swipeout-actions-no-fold") ||
            app.params.swipeoutActionsNoFold;
          ...
          if (opened) {
            openedActions =
              swipeOutEl.find(".swipeout-actions-left.swipeout-actions-opened")
                .length > 0
                ? "left"
                : "right";
          }
        ...
        if (actionsRight.length > 0) {
          ...
          if (translate < -actionsRightWidth) {
            translate =
              -actionsRightWidth -
              Math.pow(-translate - actionsRightWidth, 0.8);
          ...
          for (i = 0; i < buttonsRight.length; i++) {
            ...
            if (
              ...
              $button.hasClass("swipeout-overswipe")
            ) {
              $button.css({
            ...
            $button.transform(
              "translate3d(" +
                (translate - buttonOffset * (1 + Math.max(progress, -1))) +
                "px,0,0)",
            );
          }
        }
        if (actionsLeft.length > 0) {
          ...
          if (translate > actionsLeftWidth) {
            translate =
              actionsLeftWidth + Math.pow(translate - actionsLeftWidth, 0.8);
          ...
          for (i = 0; i < buttonsLeft.length; i++) {
            if (typeof buttonsLeft[i]._buttonOffset === "undefined") {
              buttonsLeft[i]._buttonOffset =
                actionsLeftWidth -
                buttonsLeft[i].offsetLeft -
                buttonsLeft[i].offsetWidth;
            }
            ...
            $button.transform(
              "translate3d(" +
                (translate + buttonOffset * (1 - Math.min(progress, 1))) +
                "px,0,0)",
            );
          }
        }
      ...
      function handleTouchEnd(e) {
        ...
        actionsWidth =
          direction === "to-left" ? actionsRightWidth : actionsLeftWidth;
        ...
        if (action === "open") {
          ...
          var newTranslate =
            direction === "to-left" ? -actionsWidth : actionsWidth;
        ...
        if (buttonsLeft && buttonsLeft.length > 0 && buttonsLeft !== buttons) {
          for (i = 0; i < buttonsLeft.length; i++) {
            ...
            $(buttonsLeft[i]).transform(
              "translate3d(" + buttonOffset + "px,0,0)",
            );
          }
        }
        if (
    ...
    app.swipeoutOpen = function (el, dir, callback) {
      ...
      var noFold =
        swipeOutActions.hasClass("swipeout-actions-no-fold") ||
        app.params.swipeoutActionsNoFold;
      el.trigger("open")
      ...
      var translate =
        dir === "right" ? -swipeOutActionsWidth : swipeOutActionsWidth;
      var i;
      if (buttons.length > 1) {
        for (i = 0; i < buttons.length; i++) {
          if (dir === "right") {
            $(buttons[i]).transform(
              "translate3d(" + -buttons[i].offsetLeft + "px,0,0)",
            );
          } else {
            $(buttons[i])
              .css("z-index", buttons.length - i)
              .transform(
                "translate3d(" +
                  (swipeOutActionsWidth -
                    buttons[i].offsetWidth -
                    buttons[i].offsetLeft) +
                  "px,0,0)",
              );
          }
        }
    ...
    app.swipeoutClose = function (el, callback) {
      ...
      if (app.swipeoutOpenedEl && app.swipeoutOpenedEl[0] === el[0])
        app.swipeoutOpenedEl = undefined;
    };
    app.swipeoutDelete = function (el, callback) {
      ...
      el.css({ height: 0 + "px" })
        .addClass("deleting transitioning")
        .transitionEnd(function () {
          el.trigger("deleted");
          if (callback) callback.call(el[0]);
    ...
    app.initSortable = function () {
      ...
      function handleTouchMove(e) {
        ...
        if (!isMoved) {
          ...
          maxTop =
            sortingEl.parent().height() -
            sortingEl[0].offsetTop -
            sortingEl.height();
      ...
      function handleTouchEnd(e) {
        ...
        if (
          ...
          newIndex = insertBefore
            ? insertBefore[0].f7VirtualListIndex
      ...
      $(document).on(
        app.touchEvents.start,
        ".list-block.sortable .sortable-handler",
        handleTouchStart,
      );
      ...
      selects.each(function () {
        ...
        if (itemAfter.length === 0) {
          smartSelect
            .find(".item-inner")
            .append(
              '<div class="item-after">' + valueText.join(", ") + "</div>",
            );
        } else {
          ...
          if (itemAfter.hasClass("smart-select-value")) {
            for (i = 0; i < select.length; i++) {
              select[i].selected =
                select[i].textContent.trim() === selectedText.trim();
            }
          } else {
    ...
    app.smartSelectAddOption = function (select, option, index) {
      ...
      var opened =
        $('.page.smart-select-page[data-select-name="' + selectName + '"]')
          .length > 0;
      if (opened) {
    ...
    app.smartSelectOpen = function (smartSelect, reLayout) {
      ...
      // Parameters
      var openIn =
        smartSelect.attr("data-open-in") || app.params.smartSelectOpenIn;
      if (openIn === "popup") {
        if ($(".popup.smart-select-popup").length > 0) return;
      } else if (openIn === "picker") {
        if ($(".picker-modal.modal-in").length > 0 && !reLayout) {
          if (
            smartSelect[0].f7SmartSelectPicker !==
            $(".picker-modal.modal-in:not(.modal-out)")[0]
          )
            app.closeModal($(".picker-modal.modal-in:not(.modal-out)"));
          else return;
        }
      ...
      var pageTitle =
        smartSelectData.pageTitle || smartSelect.find(".item-title").text();
      var backText = smartSelectData.backText || app.params.smartSelectBackText;
      var closeText;
      if (openIn === "picker") {
        closeText =
          smartSelectData.pickerCloseText ||
          smartSelectData.backText ||
          app.params.smartSelectPickerCloseText;
      } else {
        closeText =
          smartSelectData.popupCloseText ||
          smartSelectData.backText ||
          app.params.smartSelectPopupCloseText;
      }
      var backOnSelect =
        smartSelectData.backOnSelect !== undefined
          ? smartSelectData.backOnSelect
          : app.params.smartSelectBackOnSelect;
      var formTheme =
        smartSelectData.formTheme || app.params.smartSelectFormTheme;
      var navbarTheme =
        smartSelectData.navbarTheme || app.params.smartSelectNavbarTheme;
      var toolbarTheme =
        smartSelectData.toolbarTheme || app.params.smartSelectToolbarTheme;
      var virtualList = smartSelectData.virtualList;
      var virtualListHeight = smartSelectData.virtualListHeight;
      var material = app.params.material;
      var pickerHeight =
        smartSelectData.pickerHeight || app.params.smartSelectPickerHeight;
      ...
      if (
        select.disabled ||
        smartSelect.hasClass("disabled") ||
        $select.hasClass("disabled")
      ) {
        return;
      }
      var values = [];
      ...
      for (var i = 0; i < select.length; i++) {
        ...
        optionImage =
          ...
          $selectData.optionImage ||
          smartSelectData.optionImage;
        optionIcon =
          optionData.optionIcon ||
          $selectData.optionIcon ||
          smartSelectData.optionIcon;
      ...
      if (!app._compiledTemplates.smartSelectItem) {
        app._compiledTemplates.smartSelectItem = t7.compile(
          app.params.smartSelectItemTemplate ||
            "{{#if isLabel}}" +
      ...
      if (openIn === "picker") {
        if (!app._compiledTemplates.smartSelectToolbar) {
          app._compiledTemplates.smartSelectToolbar = t7.compile(
            app.params.smartSelectToolbarTemplate ||
        ...
        if (!app._compiledTemplates.smartSelectNavbar) {
          app._compiledTemplates.smartSelectNavbar = t7.compile(
            app.params.smartSelectNavbarTemplate ||
        ...
        if (openIn === "page") {
          navbarLayout = "static";
          if (smartSelect.parents(".navbar-through").length > 0)
            navbarLayout = "through";
          if (smartSelect.parents(".navbar-fixed").length > 0)
            navbarLayout = "fixed";
          noToolbar = smartSelect.parents(".page").hasClass("no-toolbar")
            ? "no-toolbar"
            : "";
          noNavbar = smartSelect.parents(".page").hasClass("no-navbar")
            ? "no-navbar"
            : "navbar-" + navbarLayout;
        } else {
          navbarLayout = "fixed";
      ...
      var useSearchbar =
        typeof smartSelect.data("searchbar") === "undefined"
          ? app.params.smartSelectSearchbar
          : smartSelect.data("searchbar") === "true"
            ? true
            : false;
      ...
      if (useSearchbar) {
        searchbarPlaceholder =
          smartSelect.data("searchbar-placeholder") || "Search";
        searchbarCancel = smartSelect.data("searchbar-cancel") || "Cancel";
      }

      var searchbarHTML =
        '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' +
        id +
      ...
      function scrollToInput() {
        ...
        var paddingTop = parseInt(pageContent.css("padding-top"), 10),
          ...
          pageHeight =
            pageContent[0].offsetHeight - paddingTop - picker.height(),
          pageScrollHeight =
            pageContent[0].scrollHeight - paddingTop - picker.height(),
          newPaddingBottom;
        var inputTop =
          smartSelect.offset().top - paddingTop + smartSelect[0].offsetHeight;
        if (inputTop > pageHeight) {
          var scrollTop = pageContent.scrollTop() + inputTop - pageHeight;
          if (scrollTop + pageHeight > pageScrollHeight) {
            newPaddingBottom =
              scrollTop + pageHeight - pageScrollHeight + paddingBottom;
      ...
      function closeOnHTMLClick(e) {
        var close = true;
        if (
          e.target === smartSelect[0] ||
          $(e.target).parents(smartSelect[0]).length > 0
        ) {
          close = false;
        }
      ...
      function handleInputs(container) {
        container = $(container);
        if (virtualList) {
          var virtualListInstance = app.virtualList(
            container.find(".virtual-list"),
            {
              items: values,
              ...
              searchByItem: function (query, index, item) {
                if (
                  item.text.toLowerCase().indexOf(query.trim().toLowerCase()) >=
                  0
                )
                  return true;
                return false;
          ...
          container.once(
            openIn === "popup" || openIn === "picker"
              ? "closed"
              : "pageBeforeRemove",
            function () {
              if (virtualListInstance && virtualListInstance.destroy)
        ...
        container.on("change", 'input[name="' + inputName + '"]', function () {
          ...
          if (input.type === "checkbox") {
            ...
            optionText = [
              smartSelect.find('option[value="' + value + '"]').text(),
            ];
            select.value = value;
          }
      ...
      if (openIn === "popup") {
        if (reLayout) {
          ...
          popup = app.popup(
            '<div class="popup smart-select-popup smart-select-popup-' +
              inputName +
              '">' +
        ...
        if (reLayout) {
          ...
          picker = app.pickerModal(
            '<div class="picker-modal smart-select-picker smart-select-picker-' +
              inputName +
              '"' +
              (pickerHeight ? ' style="height:' + pickerHeight + '"' : "") +
              ">" +
              toolbarHTML +
    ...
    var VirtualList = function (listBlock, params) {
      ...
      if (vl.params.template) {
        if (typeof vl.params.template === "string")
          vl.template = t7.compile(vl.params.template);
        else if (typeof vl.params.template === "function")
          vl.template = vl.params.template;
      }
      ...
      vl.render = function (force, forceScrollTop) {
        ...
        var scrollTop = -(
          vl.listBlock[0].getBoundingClientRect().top -
          vl.pageContent[0].getBoundingClientRect().top
        );
        ...
        if (
          vl.lastRepaintY === null ||
          Math.abs(scrollTop - vl.lastRepaintY) > maxBufferHeight ||
          (!updatableScroll &&
            vl.pageContent[0].scrollTop + pageHeight >=
              vl.pageContent[0].scrollHeight)
        ) {
        ...
        if (dynamicHeight) {
          ...
          for (j = 0; j < vl.heights.length; j++) {
            ...
            if (typeof fromIndex === "undefined") {
              if (
                itemTop + itemHeight >=
                scrollTop - pageHeight * 2 * vl.params.dynamicHeightBufferSize
              )
                fromIndex = j;
            ...
            if (typeof toIndex === "undefined") {
              if (
                itemTop + itemHeight >=
                  scrollTop +
                    pageHeight * 2 * vl.params.dynamicHeightBufferSize ||
          ...
          fromIndex =
            (parseInt(scrollTop / vl.params.height) - rowsBefore) *
            vl.params.cols;
          if (fromIndex < 0) {
            fromIndex = 0;
          }
          toIndex = Math.min(
            fromIndex + rowsToRender * vl.params.cols,
            items.length,
          );
        }
        ...
        for (var i = fromIndex; i < toIndex; i++) {
          ...
          if (vl.domCache[index]) {
            ...
            if (vl.template) {
              ...
              vl.tempDomElement.innerHTML = vl.params.renderItem(
                index,
                items[i],
              );
            } else {
          ...
          // Before item insert
          if (vl.params.onItemBeforeInsert)
            vl.params.onItemBeforeInsert(vl, item);
        ...
        if (!updatableScroll) {
          if (dynamicHeight) {
            ...
            vl.ul[0].style.height =
              (i * vl.params.height) / vl.params.cols + "px";
          }
        }
        ...
        if (vl.params.onItemsBeforeInsert)
          vl.params.onItemsBeforeInsert(vl, vl.fragment);
        vl.ul[0].appendChild(vl.fragment);
        if (vl.params.onItemsAfterInsert)
          vl.params.onItemsAfterInsert(vl, vl.fragment);
      ...
      vl.scrollToItem = function (index) {
        ...
        vl.render(
          true,
          listTop + itemTop - parseInt(vl.pageContent.css("padding-top"), 10),
        );
        return true;
      };
    ...
    app.initPullToRefresh = function (pageContainer) {
      ...
      var touchId,
        ...
        pullStarted;
      var page = eventsTarget.hasClass("page")
        ? eventsTarget
        : eventsTarget.parents(".page");
      var hasNavbar = false;
      if (
        page.find(".navbar").length > 0 ||
        page.parents(".navbar-fixed, .navbar-through").length > 0 ||
        page.hasClass("navbar-fixed") ||
        page.hasClass("navbar-through")
      )
        hasNavbar = true;
      ...
      function handleTouchMove(e) {
        ...
        if (!isMoved) {
          ...
          if (dynamicTriggerDistance) {
            ...
            if (triggerDistance.indexOf("%") >= 0)
              triggerDistance =
                (container[0].offsetHeight * parseInt(triggerDistance, 10)) /
                100;
          }
          startTranslate = container.hasClass("refreshing")
            ? triggerDistance
            : 0;
          if (
        ...
        if ((touchesDiff > 0 && scrollTop <= 0) || scrollTop < 0) {
          ...
          if (
            app.device.os === "ios" &&
            parseInt(app.device.osVersion.split(".")[0], 10) > 7 &&
            scrollTop === 0 &&
            !wasScrolled
          )
            useTranslate = true;
          ...
          if (
            (useTranslate && Math.pow(touchesDiff, 0.85) > triggerDistance) ||
            (!useTranslate && touchesDiff >= triggerDistance * 2)
          ) {
            refresh = true;
    ...
    app.destroyPullToRefresh = function (pageContainer) {
      pageContainer = $(pageContainer);
      var pullToRefreshContent = pageContainer.hasClass(
        "pull-to-refresh-content",
      )
        ? pageContainer
        : pageContainer.find(".pull-to-refresh-content");
      if (pullToRefreshContent.length === 0) return;
      if (pullToRefreshContent[0].f7DestroyPullToRefresh)
        pullToRefreshContent[0].f7DestroyPullToRefresh();
    };
    ...
    app.initPageScrollToolbars = function (pageContainer) {
      ...
      var hideNavbar =
        (app.params.hideNavbarOnPageScroll ||
          scrollContent.hasClass("hide-navbar-on-scroll") ||
          scrollContent.hasClass("hide-bars-on-scroll")) &&
        !(
          scrollContent.hasClass("keep-navbar-on-scroll") ||
          scrollContent.hasClass("keep-bars-on-scroll")
        );
      var hideToolbar =
        (app.params.hideToolbarOnPageScroll ||
          scrollContent.hasClass("hide-toolbar-on-scroll") ||
          scrollContent.hasClass("hide-bars-on-scroll")) &&
        !(
          scrollContent.hasClass("keep-toolbar-on-scroll") ||
          scrollContent.hasClass("keep-bars-on-scroll")
        );
      var hideTabbar =
        (app.params.hideTabbarOnPageScroll ||
          scrollContent.hasClass("hide-tabbar-on-scroll")) &&
        !scrollContent.hasClass("keep-tabbar-on-scroll");
      ...
      var toolbarHeight =
        hasToolbar && hideToolbar ? toolbar[0].offsetHeight : 0;
      ...
      function handleScroll(e) {
        ...
        reachEnd =
          currentScroll + offsetHeight >= scrollHeight - bottomBarHeight;
    ...
    app.materialTabbarSetHighlight = function (tabbar, activeLink) {
      ...
      if (tabbar.hasClass("tabbar-scrollable")) {
        ...
        highlightTranslate =
          (app.rtl ? -activeLink[0].offsetLeft : activeLink[0].offsetLeft) +
          "px";
      } else {
        tabLinkWidth = (1 / tabbar.find(".tab-link").length) * 100 + "%";
        highlightTranslate =
          (app.rtl ? -activeLink.index() : activeLink.index()) * 100 + "%";
      }

      tabbar
        .find(".tab-link-highlight")
    ...
    app.showTab = function (tab, tabLink, force) {
      ...
      if (isSwipeableTabs) {
        ...
        if (swiper.activeIndex !== newTab.index())
          swiper.slideTo(newTab.index(), undefined, false);
      }
    ...
    app.accordionOpen = function (item) {
      ...
      var expandedItem =
        list.length > 0 && item.parent().children(".accordion-item-expanded");
    ...
    app.initFastClicks = function () {
      ...
      function isFormElement(el) {
        ...
        if (el.nodeName && nodes.indexOf(el.nodeName.toLowerCase()) >= 0)
          return true;
        return false;
      }
      ...
      function targetNeedsFastClick(el) {
        ...
        if (el.nodeName.toLowerCase() === "input" && el.type === "file")
          return false;
        if (
          $el.hasClass("no-fastclick") ||
          $el.parents(".no-fastclick").length > 0
        )
          return false;
        return true;
      }
      ...
      function sendClick(e) {
        ...
        if (
          app.device.android &&
          targetElement.nodeName.toLowerCase() === "select"
        ) {
          eventType = "mousedown";
        }
        evt.initMouseEvent(
      ...
      function handleTouchStart(e) {
        ...
        if (app.device.ios) {
          ...
          if (
            ...
            (!selection.isCollapsed ||
              document.activeElement === selection.focusNode)
          ) {
        ...
        if (
          e.timeStamp - lastClickTime <
          app.params.fastClicksDelayBetweenClicks
        ) {
          e.preventDefault();
        }
      ...
      function handleTouchMove(e) {
        ...
        if (distance) {
          ...
          if (
            Math.abs(pageX - touchStartX) > distance ||
            Math.abs(pageY - touchStartY) > distance
          ) {
            _isMoved = true;
          }
        } else {
      ...
      function handleTouchEnd(e) {
        ...
        if (
          ...
          document.activeElement !== document.body &&
          targetElement.nodeName.toLowerCase() !== "label"
        ) {
          document.activeElement.blur();
        }
      ...
      function handleClick(e) {
        ...
        if (
          app.params.tapHold &&
          app.params.tapHoldPreventClicks &&
          tapHoldFired
        ) {
          allowClick = false;
        }
    ...
    app.initClickEvents = function () {
      function handleScrollTop(e) {
        ...
        if (
          app.params.scrollTopOnNavbarClick &&
          clicked.is(".navbar .center")
        ) {
          // Find active page
            ...
            if (pageContent.length === 0) {
              if (navbar.nextAll(".pages").length > 0) {
                pageContent = navbar
                  .nextAll(".pages")
                  .find(
                    ".page:not(.page-on-left):not(.page-on-right):not(.cached)",
                  )
                  .find(".page-content");
              }
            }
        ...
        if (
          app.params.scrollTopOnStatusbarClick &&
          clicked.is(".statusbar-overlay")
        ) {
          if ($(".popup.modal-in").length > 0) {
            // Check for opened popup
            pageContent = $(".popup.modal-in")
              .find(".page:not(.page-on-left):not(.page-on-right):not(.cached)")
              .find(".page-content");
          } else if ($(".panel.active").length > 0) {
            // Check for opened panel
            pageContent = $(".panel.active")
              .find(".page:not(.page-on-left):not(.page-on-right):not(.cached)")
              .find(".page-content");
          } else if ($(".views > .view.active").length > 0) {
            // View in tab bar app layout
            pageContent = $(".views > .view.active")
              .find(".page:not(.page-on-left):not(.page-on-right):not(.cached)")
              .find(".page-content");
          } else {
            // Usual case
      ...
      function handleClicks(e) {
        ...
        if (isLink) {
          if (
            clicked.is(app.params.externalLinks) ||
        ...
        if (
          clicked.hasClass("panel-overlay") &&
          app.params.panelsCloseByOutside
        ) {
          app.closePanel();
        }
        // Popover
        ...
        if (clicked.hasClass("modal-overlay")) {
          if ($(".modal.modal-in").length > 0 && app.params.modalCloseByOutside)
            app.closeModal(".modal.modal-in");
          if (
            $(".actions-modal.modal-in").length > 0 &&
            app.params.actionsCloseByOutside
          )
        ...
        // Accordion
        if (
          clicked.hasClass("accordion-item-toggle") ||
          (clicked.hasClass("item-link") &&
            clicked.parent().hasClass("accordion-item"))
        ) {
          var accordionItem = clicked.parent(".accordion-item");
          if (accordionItem.length === 0)
            accordionItem = clicked.parents(".accordion-item");
        ...
        if (app.params.material) {
          if (
            clicked.hasClass("floating-button") &&
            clicked.parent().hasClass("speed-dial")
          ) {
        ...
        // Load Page
        if (
          (app.params.ajaxLinks && !clicked.is(app.params.ajaxLinks)) ||
          !isLink ||
          !app.params.router
        ) {
          return;
        ...
        if (validUrl || clicked.hasClass("back") || template) {
          ...
          if (clickedData.view) {
            ...
            view =
              clicked.parents("." + app.params.viewClass)[0] &&
              clicked.parents("." + app.params.viewClass)[0].f7View;
            if (view && view.params.linksView) {
              if (typeof view.params.linksView === "string")
                view = $(view.params.linksView)[0].f7View;
              else if (view.params.linksView instanceof View)
      ...
      if (
        ...
        $(document).on(
          "click",
          ".statusbar-overlay, .navbar .center",
          handleScrollTop,
        );
      }
      ...
      if (app.support.touch && !app.device.android) {
        $(document).on(
          app.params.fastClicks ? "touchstart" : "touchmove",
          ".panel-overlay, .modal-overlay, .preloader-indicator-overlay, .popup-overlay, .searchbar-overlay",
          preventScrolling,
        );
      }
    };
        ...
        if (tag === "select" && input.prop("multiple")) {
          ...
          switch (type) {
            case "checkbox":
              skipNames.push(name);
              form.find('input[name="' + name + '"]').each(function () {
                if (formData[name].indexOf(this.value) >= 0)
                  this.checked = true;
      ...
      pageContainer.find(".item-input").each(function () {
        ...
        itemInput.find("input, select, textarea").each(function () {
          ...
          if (notInputs.indexOf(input.attr("type")) < 0) {
            ...
            if (input.val().trim() !== "") {
              input
                .parents(".item-input, .input-field")
                .add(input.parents(".item-inner"))
                .addClass("not-empty-state");
            }
          }
        });
    ...
    app.initMaterialWatchInputs = function () {
      ...
      function addFocusState(e) {
        ...
        var els = i
          .add(i.parents(".item-input, .input-field"))
          .add(i.parents(".item-inner").eq(0));
      ...
      $(document).on(
        "change",
        ".item-input input, .item-input select, .item-input textarea, input, textarea, select",
        watchChangeState,
        true,
      );
      $(document).on(
    ...
    var PhotoBrowser = function (params) {
      ...
      pb.params = params;
      pb.params.iconsColorClass = pb.params.iconsColor
        ? "color-" + pb.params.iconsColor
        : pb.params.theme === "dark"
          ? "color-white"
          : "";
      pb.params.preloaderColorClass =
        pb.params.theme === "dark" ? "preloader-white" : "";

      // Templates
      var photoTemplate =
        pb.params.photoTemplate ||
        '<div class="photo-browser-slide swiper-slide">' +
          '<span class="photo-browser-zoom-container">' +
          '<img src="{{js "this.url || this"}}">' +
          "</span>" +
          "</div>";
      var photoLazyTemplate =
        pb.params.lazyPhotoTemplate ||
      ...
      pb.open = function (index) {
        ...
        if (pb.params.type === "popup") {
          pb.popup = app.popup(
            '<div class="popup photo-browser-popup">' + htmlTemplate + "</div>",
          );
      ...
      pb.close = function () {
        ...
        if (pb.params.type === "standalone") {
          pb.container
            .removeClass("photo-browser-in")
            .addClass("photo-browser-out")
            .animationEnd(function () {
              pb.container.remove();
            });
        }
      ...
      pb.onSliderTransitionStart = function (swiper) {
        ...
        $(".photo-browser-prev, .photo-browser-next").removeClass(
        ...
        if (pb.captions.length > 0) {
          ...
          var captionIndex = pb.params.loop
            ? swiper.slides
        ...
        // Stop Video
        var previousSlideVideo = swiper.slides
          .eq(swiper.previousIndex)
          .find("video");
      ...
      pb.layout = function (index) {
        ...
        pb.swiperContainer = pb.container.find(
      ...
      pb.attachEvents = function (detach) {
        ...
        pb.container
          .find(".photo-browser-close-link")
          [action]("click", pb.close);
      };
      ...
      pb.onSlideGestureChange = function (e) {
        ...
        if (scale > pb.params.maxZoom) {
          scale =
            pb.params.maxZoom -
            1 +
            Math.pow(scale - pb.params.maxZoom + 1, 0.5);
        }
        if (scale < pb.params.minZoom) {
          scale =
            pb.params.minZoom +
            1 -
            Math.pow(pb.params.minZoom - scale + 1, 0.5);
        }
        ...
        if (scale && scale !== 1) {
          ...
          if (e) {
            ...
            translateMinY = Math.min(
              pb.swiper.height / 2 - scaledHeight / 2,
              0,
            );
      ...
      pb.onSlideTouchMove = function (e) {
        ...
        imageTouchesCurrent.x =
          e.type === "touchmove" ? e.targetTouches[0].pageX : e.pageX;
        imageTouchesCurrent.y =
          e.type === "touchmove" ? e.targetTouches[0].pageY : e.pageY;

        if (!imageIsMoved && !isScaling) {
          if (
            (Math.floor(imageMinX) === Math.floor(imageStartX) &&
              imageTouchesCurrent.x < imageTouchesStart.x) ||
        ...
        imageIsMoved = true;
        imageCurrentX =
          imageTouchesCurrent.x - imageTouchesStart.x + imageStartX;
        imageCurrentY =
          imageTouchesCurrent.y - imageTouchesStart.y + imageStartY;

        if (imageCurrentX < imageMinX) {
          imageCurrentX =
            imageMinX + 1 - Math.pow(imageMinX - imageCurrentX + 1, 0.8);
        }
        if (imageCurrentX > imageMaxX) {
          imageCurrentX =
            imageMaxX - 1 + Math.pow(imageCurrentX - imageMaxX + 1, 0.8);
        }

        if (imageCurrentY < imageMinY) {
          imageCurrentY =
            imageMinY + 1 - Math.pow(imageMinY - imageCurrentY + 1, 0.8);
        }
        if (imageCurrentY > imageMaxY) {
          imageCurrentY =
            imageMaxY - 1 + Math.pow(imageCurrentY - imageMaxY + 1, 0.8);
        }
        ...
        velocityX =
          (imageTouchesCurrent.x - velocityPrevPositionX) /
          (Date.now() - velocityPrevTime) /
          2;
        velocityY =
          (imageTouchesCurrent.y - velocityPrevPositionY) /
          (Date.now() - velocityPrevTime) /
          2;
        ...
        gestureImgWrap.transform(
          "translate3d(" + imageCurrentX + "px, " + imageCurrentY + "px,0)",
        );
      };
      pb.onSlideTouchEnd = function (e) {
        ...
        if (velocityX !== 0)
          momentumDurationX = Math.abs(
            (newPositionX - imageCurrentX) / velocityX,
          );
        if (velocityY !== 0)
          momentumDurationY = Math.abs(
            (newPositionY - imageCurrentY) / velocityY,
          );
      ...
      pb.swipeCloseTouchMove = function (swiper, e) {
        ...
        swipeToCloseActiveSlide.transform(
          "translate3d(0," + -swipeToCloseDiff + "px,0)",
        );
    ...
    var Autocomplete = function (params) {
      ...
      if (a.params.openIn !== "dropdown") {
        // Item Template
        a.itemTemplate = t7.compile(
          a.params.itemTemplate ||
            "<li>" +
              '<label class="label-{{inputType}} item-content">' +
              '<input type="{{inputType}}" name="{{inputName}}" value="{{value}}" {{#if selected}}checked{{/if}}>' +
              "{{#if material}}" +
        ...
        a.navbarTemplate = t7.compile(
          a.params.navbarTemplate ||
            '<div class="navbar {{#if navbarTheme}}theme-{{navbarTheme}}{{/if}}">' +
              '<div class="navbar-inner">' +
              '<div class="left sliding">' +
              "{{#if material}}" +
        ...
        if (a.params.openIn === "page") {
          navbarLayout = "static";
          if (a.opener) {
            if (a.opener.parents(".navbar-through").length > 0)
              navbarLayout = "through";
            if (a.opener.parents(".navbar-fixed").length > 0)
              navbarLayout = "fixed";
            noToolbar = a.opener.parents(".page").hasClass("no-toolbar")
              ? "no-toolbar"
              : "";
            noNavbar = a.opener.parents(".page").hasClass("no-navbar")
              ? "no-navbar"
              : "navbar-" + navbarLayout;
          } else if (view.container) {
            if (
              $(view.container).hasClass("navbar-through") ||
              $(view.container).find(".navbar-through").length > 0
            )
              navbarLayout = "through";
            if (
              $(view.container).hasClass("navbar-fixed") ||
              $(view.container).find(".navbar-fixed").length > 0
            )
              navbarLayout = "fixed";
            noToolbar = $(view.activePage.container).hasClass("no-toolbar")
              ? "no-toolbar"
              : "";
            noNavbar = $(view.activePage.container).hasClass("no-navbar")
              ? "no-navbar"
              : "navbar-" + navbarLayout;
          }
        } else {
        ...
        var searchbarHTML =
          ...
          '<div class="searchbar-input">' +
          '<input type="search" placeholder="' +
          a.params.searchbarPlaceholderText +
          '">' +
          '<a href="#" class="searchbar-clear"></a>' +
          "</div>" +
          (material
        ...
        var pageHTML =
          ...
          '<div class="list-block autocomplete-found autocomplete-list-' +
          a.id +
          " " +
          (formTheme ? "theme-" + formTheme : "") +
          '">' +
          ...
          '<ul><li class="item-content"><div class="item-inner"><div class="item-title">' +
        ...
        a.dropdownItemTemplate = t7.compile(
          a.params.dropdownItemTemplate ||
            "<li>" +
        ...
        a.dropdownPlaceholderTemplate = t7.compile(
          a.params.dropdownPlaceholderTemplate ||
        ...
        a.dropdownTemplate = t7.compile(
          a.params.dropdownTemplate ||
      ...
      a.handleInputValue = function (e) {
        ...
        if (a.params.source) {
          a.params.source(a, query, function (items) {
            var itemsHTML = "";
            var limit = a.params.limit
              ? Math.min(a.params.limit, items.length)
              : items.length;
            a.items = items;
            var i, j;
            ...
            for (i = 0; i < limit; i++) {
              var itemValue =
                typeof items[i] === "object"
                  ? items[i][a.params.valueProperty]
                  : items[i];
              itemsHTML += a.dropdownItemTemplate({
                value: itemValue,
                text: (typeof items[i] !== "object"
                  ? items[i]
                  : items[i][a.params.textProperty]
            ...
            if (
              itemsHTML === "" &&
              query === "" &&
              a.params.dropdownPlaceholderText
            ) {
      ...
      a.handleDropdownClick = function (e) {
        ...
        for (var i = 0; i < a.items.length; i++) {
          var itemValue =
            typeof a.items[i] === "object"
              ? a.items[i][a.params.valueProperty]
              : a.items[i];
        ...
        if (a.params.updateInputValueOnSelect) {
          a.input.val(
            typeof clickedItem === "object"
              ? clickedItem[a.params.textProperty]
              : clickedItem,
          );
      ...
      a.positionDropDown = function () {
        var listBlock = a.input.parents(".list-block"),
          ...
          maxHeight =
            pageContent[0].scrollHeight -
            paddingBottom -
            (inputOffset.top + pageContent[0].scrollTop) -
            a.input[0].offsetHeight;

        a.dropdown.css({
          left:
            (listBlock.length > 0 ? listBlockOffset.left : inputOffset.left) +
            "px",
          top:
            inputOffset.top +
          ...
          width:
            (listBlock.length > 0
              ? listBlock[0].offsetWidth
              : a.input[0].offsetWidth) + "px",
        });
        a.dropdown.children(".autocomplete-dropdown-inner").css({
          maxHeight: maxHeight + "px",
          paddingLeft:
            listBlock.length > 0 && !a.params.expandInput
              ? inputOffset.left - (material ? 16 : 15) + "px"
              : "",
        });
      };
      ...
      a.pageInit = function (e) {
              ...
              a.params.source(a, data.query, function (items) {
                ...
                for (i = 0; i < limit; i++) {
                  ...
                  for (j = 0; j < a.value.length; j++) {
                    var aValue =
                      typeof a.value[j] === "object"
                        ? a.value[j][a.params.valueProperty]
                        : a.value[j];
        ...
        function updateValues() {
          ...
          for (i = 0; i < a.value.length; i++) {
            valuesHTML += a.itemTemplate({
              value:
                typeof a.value[i] === "object"
                  ? a.value[i][a.params.valueProperty]
                  : a.value[i],
              text:
                typeof a.value[i] === "object"
                  ? a.value[i][a.params.textProperty]
                  : a.value[i],
              inputType: a.inputType,
              id: a.id,
        ...
        container.on(
          ...
          function () {
            ...
            // On Select Callback
            if (
              ((a.inputType === "radio" && input.checked) ||
      ...
      a.showPreloader = function () {
        if (a.params.openIn === "dropdown") {
          ...
          $(".autocomplete-preloader").addClass(
      ...
      a.hidePreloader = function () {
        if (a.params.openIn === "dropdown") {
          ...
          $(".autocomplete-preloader").removeClass(
            "autocomplete-preloader-visible",
          );
      };
      ...
      a.open = function () {
        ...
        if (a.params.openIn === "dropdown") {
          ...
          if (
            listBlock.length &&
            a.input.parents(".item-content").length > 0 &&
            a.params.expandInput
          ) {
            a.input
              .parents(".item-content")
              .addClass("item-content-dropdown-expand");
          }
          a.positionDropDown();
          ...
          if (a.params.openIn === "popup") {
            a.popup = app.popup(
              '<div class="popup autocomplete-popup autocomplete-popup-' +
                a.inputName +
                '">' +
                '<div class="view navbar-fixed">' +
                pageHTML +
      ...
      a.close = function (e) {
        ...
        if (a.params.openIn === "dropdown") {
          if (
            e &&
            e.type === "blur" &&
            a.dropdown.find("label.active-state").length > 0
          )
            return;
          a.dropdown.removeClass("autocomplete-dropdown-in").remove();
          a.input
            .parents(".item-content-dropdown-expand")
            .removeClass("item-content-dropdown-expand");
          a.opened = false;
    ...
    var Picker = function (params) {
      ...
      p.updateValue = function (forceValues) {
        ...
        if (p.input && p.input.length > 0) {
          $(p.input).val(
            p.params.formatValue
              ? p.params.formatValue(p, p.value, p.displayValue)
              : p.value.join(" "),
          );
      ...
      p.initPickerCol = function (colElement, updateItems) {
        ...
        col.wrapper
          .transform("translate3d(0," + maxTranslate + "px,0)")
          .transition(0);
        ...
        col.setValue = function (newValue, transition, valueCallbacks) {
          ...
          // Watch items
          if (
            p.params.updateValuesOnMomentum &&
            col.activeIndex &&
        ...
        col.updateItems = function (
          ...
          if (p.params.rotateEffect) {
            var percentage =
              (translate -
                (Math.floor((translate - maxTranslate) / itemHeight) *
                  itemHeight +
                  maxTranslate)) /
              itemHeight;
          ...
          if (valueCallbacks || typeof valueCallbacks === "undefined") {
            ...
            col.displayValue = col.displayValues
              ? col.displayValues[activeIndex]
              : col.value;
            // On change callback
        ...
        function handleTouchStart(e) {
          ...
          allowItemClick = true;
          startTranslate = currentTranslate = $.getTranslate(
            col.wrapper[0],
            "y",
          );
        }
        function handleTouchMove(e) {
          ...
          if (currentTranslate < minTranslate) {
            currentTranslate =
              minTranslate - Math.pow(minTranslate - currentTranslate, 0.8);
            returnTo = "min";
          }
          if (currentTranslate > maxTranslate) {
            currentTranslate =
              maxTranslate + Math.pow(currentTranslate - maxTranslate, 0.8);
            returnTo = "max";
          }
          // Transform wrapper
          ...
          col.updateItems(
            ...
            currentTranslate,
            0,
            p.params.updateValuesOnTouchmove,
          );

          // Calc velocity
          velocityTranslate =
            currentTranslate - prevTranslate || currentTranslate;
        ...
        function handleTouchEnd(e) {
          ...
          if (touchEndTime - touchStartTime > 300) {
            ...
            velocity = Math.abs(
              velocityTranslate / (touchEndTime - velocityTime),
            );
            newTranslate =
              currentTranslate + velocityTranslate * p.params.momentumRatio;
          }
          ...
          var activeIndex = -Math.floor(
            (newTranslate - maxTranslate) / itemHeight,
          );
          ...
          // Transform wrapper
          col.wrapper.transform(
            "translate3d(0," + parseInt(newTranslate, 10) + "px,0)",
          );
      ...
      p.layout = function () {
        ...
        pickerClass =
          ...
          (p.params.cssClass || "") +
          (p.params.rotateEffect ? " picker-3d" : "");
        pickerHTML =
          '<div class="' +
          pickerClass +
          '">' +
      ...
      function openOnInput(e) {
        ...
        if (p.params.scrollToInput && !isPopover()) {
          ...
          var paddingTop = parseInt(pageContent.css("padding-top"), 10),
            paddingBottom = parseInt(pageContent.css("padding-bottom"), 10),
            pageHeight =
              pageContent[0].offsetHeight - paddingTop - p.container.height(),
            pageScrollHeight =
              pageContent[0].scrollHeight - paddingTop - p.container.height(),
            newPaddingBottom;
          var inputTop =
            p.input.offset().top - paddingTop + p.input[0].offsetHeight;
          if (inputTop > pageHeight) {
            var scrollTop = pageContent.scrollTop() + inputTop - pageHeight;
            if (scrollTop + pageHeight > pageScrollHeight) {
              newPaddingBottom =
      ...
      function closeOnHTMLClick(e) {
        ...
        if (p.input && p.input.length > 0) {
          if (
            e.target !== p.input[0] &&
            $(e.target).parents(".picker-modal").length === 0
          )
            p.close();
        } else {
      ...
      if (!p.inline && p.params.closeByOutsideClick)
        $("html").on("click", closeOnHTMLClick);
      ...
      p.open = function () {
        ...
        if (!p.opened) {
          ...
          p.container.find(".picker-items-col").each(function () {
            ...
            if (
              (!p.initialized && p.params.value) ||
              (p.initialized && p.value)
            )
              updateItems = false;
    ...
    var Calendar = function (params) {
      ...
      p.updateValue = function (onlyHeader) {
        ...
        if (
          ...
          (app.params.material && p.params.header)
        ) {
      ...
      p.initCalendarEvents = function () {
        ...
        function handleTouchMove(e) {
          ...
          p.wrapper.transform(
            "translate3d(" +
              (p.isH ? currentTranslate : 0) +
              "%, " +
              (p.isH ? 0 : currentTranslate) +
              "%, 0)",
          );
        }
        function handleTouchEnd(e) {
        ...
        function handleDayClick(e) {
          ...
          if (
            day.hasClass("picker-calendar-day-selected") &&
            !(p.params.multiple || p.params.rangePicker)
          )
            return;
          ...
          if (p.params.closeOnSelect) {
            if (
              (p.params.rangePicker && p.value.length === 2) ||
              !p.params.rangePicker
            )
              p.close();
          }
        }
      ...
      p.dateInRange = function (dayDate, range) {
        ...
        if ($.isArray(range)) {
          ...
          if (range.from && range.to) {
            if (
              dayDate <= new Date(range.to).getTime() &&
              dayDate >= new Date(range.from).getTime()
            ) {
              match = true;
            }
          } else if (range.from) {
      ...
      p.monthHTML = function (date, offset) {
        ...
        var daysInPrevMonth = p.daysInMonth(
        ...
        var dayDate,
          ...
          minDate = p.params.minDate
            ? new Date(p.params.minDate).getTime()
            : null,
          maxDate = p.params.maxDate
        ...
        for (i = 1; i <= rows; i++) {
          ...
          for (j = 1; j <= cols; j++) {
            ...
            var weekDayIndex =
              col - 1 + p.params.firstDay > 6
                ? col - 1 - 7 + p.params.firstDay
                : col - 1 + p.params.firstDay;
            var addClass = "";
            if (dayNumber < 0) {
      ...
      p.updateCurrentMonthYear = function (dir) {
        if (typeof dir === "undefined") {
          ...
          p.currentMonth = parseInt(
            p.months
              .eq(dir === "next" ? p.months.length - 1 : 0)
              .attr("data-month"),
            10,
          );
      ...
      p.onMonthChangeEnd = function (dir, rebuildBoth) {
        ...
        if (!rebuildBoth) {
          newMonthHTML = p.monthHTML(
            new Date(p.currentYear, p.currentMonth),
            dir,
          );
        } else {
          p.wrapper
            .find(".picker-calendar-month-next, .picker-calendar-month-prev")
            .remove();
          prevMonthHTML = p.monthHTML(
            new Date(p.currentYear, p.currentMonth),
            "prev",
          );
          nextMonthHTML = p.monthHTML(
            new Date(p.currentYear, p.currentMonth),
            "next",
          );
        }
      ...
      p.setMonthsTranslate = function (translate) {
        ...
        p.months
          ...
          .transform(
            "translate3d(" +
              (p.isH ? prevMonthTranslate : 0) +
              "%, " +
              (p.isH ? 0 : prevMonthTranslate) +
              "%, 0)",
          )
        ...
        p.months
          ...
          .transform(
            "translate3d(" +
              (p.isH ? currentMonthTranslate : 0) +
              "%, " +
              (p.isH ? 0 : currentMonthTranslate) +
              "%, 0)",
          )
        ...
        p.months
          ...
          .transform(
            "translate3d(" +
              (p.isH ? nextMonthTranslate : 0) +
              "%, " +
              (p.isH ? 0 : nextMonthTranslate) +
              "%, 0)",
          )
      ...
      p.nextMonth = function (transition) {
        ...
        if (nextMonth === p.currentMonth) {
          ...
          var nextMonthHTML = $(p.monthHTML(nextDateTime, "next"))
            .transform(
              "translate3d(" +
                (p.isH ? nextMonthTranslate : 0) +
                "%, " +
      ...
      p.prevMonth = function (transition) {
        ...
        if (prevMonth === p.currentMonth) {
          ...
          var prevMonthHTML = $(p.monthHTML(prevDateTime, "prev"))
            .transform(
              "translate3d(" +
                (p.isH ? prevMonthTranslate : 0) +
                "%, " +
      ...
      p.setYearMonth = function (year, month, transition) {
        ...
        if (
          p.params.maxDate &&
          targetDate > new Date(p.params.maxDate).getTime()
        ) {
          return false;
        }
        if (
          p.params.minDate &&
          targetDate < new Date(p.params.minDate).getTime()
        ) {
          return false;
        }
        ...
        if (targetDate > currentDate) {
          ...
          p.months
            ...
            .transform(
              "translate3d(" +
                (p.isH ? monthTranslate : 0) +
                "%, " +
                (p.isH ? 0 : monthTranslate) +
                "%, 0)",
            )
            .addClass("picker-calendar-month-next");
        } else {
        ...
        p.wrapper
          ...
          .transform(
            "translate3d(" +
              (p.isH ? wrapperTranslate : 0) +
              "%, " +
              (p.isH ? 0 : wrapperTranslate) +
              "%, 0)",
          );
        if (transitionEndCallback) {
          p.wrapper.transitionEnd(function () {
      ...
      p.layout = function () {
        ...
        if (p.params.weekHeader) {
          for (i = 0; i < 7; i++) {
            var weekDayIndex =
              i + p.params.firstDay > 6
                ? i - 7 + p.params.firstDay
                : i + p.params.firstDay;
            var dayName = p.params.dayNamesShort[weekDayIndex];
            weekHeaderHTML +=
              '<div class="picker-calendar-week-day ' +
              (p.params.weekendDays.indexOf(weekDayIndex) >= 0
        ...
        var toolbarHTML = p.params.toolbar
          ? p.params.toolbarTemplate.replace(
              /{{closeText}}/g,
              p.params.toolbarCloseText,
            )
        ...
        var headerHTML = p.params.header
          ? p.params.headerTemplate
              .replace(/{{closeText}}/g, p.params.toolbarCloseText)
              .replace(/{{placeholder}}/g, p.params.headerPlaceholder)
          : "";
        var footerHTML = p.params.footer
          ? p.params.footerTemplate.replace(
              /{{closeText}}/g,
              p.params.toolbarCloseText,
            )
          : "";
    ...
    app.addNotification = function (params) {
      ...
      if (typeof params.media === "undefined")
        params.media = app.params.notificationMedia;
      if (typeof params.title === "undefined")
        params.title = app.params.notificationTitle;
      if (typeof params.subtitle === "undefined")
        params.subtitle = app.params.notificationSubtitle;
      if (typeof params.closeIcon === "undefined")
        params.closeIcon = app.params.notificationCloseIcon;
      if (typeof params.hold === "undefined")
        params.hold = app.params.notificationHold;
      if (typeof params.closeOnClick === "undefined")
        params.closeOnClick = app.params.notificationCloseOnClick;
      if (typeof params.button === "undefined")
        params.button = app.params.notificationCloseButtonText && {
          text: app.params.notificationCloseButtonText,
          close: true,
        };

      if (!_tempNotificationElement)
        _tempNotificationElement = document.createElement("div");
      ...
      if (container.length === 0) {
        $("body").append(
          '<div class="notifications list-block' +
            (params.material ? "" : " media-list") +
            '"><ul></ul></div>',
        );
      ...
      var notificationTemplate =
        app.params.notificationTemplate ||
        "{{#if custom}}" +
          "<li>{{custom}}</li>" +
          "{{else}}" +
      ...
      _tempNotificationElement.innerHTML =
        app._compiledTemplates.notification(params);
      ...
      item.on("click", function (e) {
        ...
        if (params.material && target.hasClass("button")) {
          if (params.button && params.button.onClick)
            params.button.onClick.call(target[0], e, item[0]);
        }
        if (
          target.is(".close-notification") ||
          $(e.target).parents(".close-notification").length > 0
        ) {
          close = true;
        } else {
    ...
    app.closeNotification = function (item) {
      ...
      item
        ...
        .transition(0)
        .addClass("notification-item-removing");
      var clientLeft = item[0].clientLeft;

      item.css("height", "0px").transition("");
      if (item.data("f7NotificationOnClose"))
        item.data("f7NotificationOnClose")();

      if (
        container.find(".notification-item:not(.notification-item-removing)")
          .length === 0
      ) {
        container.transform("");
      }
    ...
    app.pluginProcess = function (process, data) {
      ...
      for (var i = 0; i < _plugins.length; i++) {
        if (_plugins[i].preprocess && process in _plugins[i].preprocess) {
          processed = _plugins[i].preprocess[process](
            data,
            arguments[2],
            arguments[3],
            arguments[4],
    ...
    app.init = function () {
      ...
      // Init Material Inputs
      if (app.params.material && app.initMaterialWatchInputs)
        app.initMaterialWatchInputs();
  ...
  var Dom7 = (function () {
          ...
          if (el.dataset) {
            ...
            for (var i = 0; i < el.attributes.length; i++) {
              ...
              if (attr.name.indexOf("data-") >= 0) {
                dataset[$.toCamelCase(attr.name.split("data-")[1])] =
                  attr.value;
              }
            }
          }
    ...
    (function () {
      var shortcuts =
        "click blur focus focusin focusout keyup keydown keypress submit change mousedown mousemove mouseup mouseenter mouseleave mouseout mouseover touchstart touchend touchmove resize scroll".split(
          " ",
        );
  ...
  Framework7.prototype.device = (function () {
    ...
    if (device.os && device.os === "ios") {
      ...
      device.minimalUi =
        ...
        $('meta[name="viewport"]').attr("content").indexOf("minimal-ui") >= 0;
    }
  ...
  window.Swiper = function (container, params) {
    ...
    s.updateAutoHeight = function () {
      ...
      if (newHeight)
        s.wrapper.css(
          "height",
          s.slides.eq(s.activeIndex)[0].offsetHeight + "px",
        );
    };
    ...
    s.updateSlidesOffset = function () {
      for (var i = 0; i < s.slides.length; i++) {
        s.slides[i].swiperSlideOffset = isH()
    ...
    s.updateClasses = function () {
      ...
      if (s.bullets && s.bullets.length > 0) {
        ...
        if (s.params.loop) {
          bulletIndex =
            Math.ceil(s.activeIndex - s.loopedSlides) / s.params.slidesPerGroup;
      ...
      if (s.paginationContainer && s.paginationContainer.length > 0) {
        ...
        for (var i = 0; i < numberOfBullets; i++) {
          if (s.params.paginationBulletRender) {
            bulletsHTML += s.params.paginationBulletRender(
              i,
    ...
    s.updateClickedSlide = function (e) {
      ...
      if (
        ...
        if (s.params.loop) {
          ...
          if (s.params.centeredSlides) {
            if (
              slideToIndex < s.loopedSlides - s.params.slidesPerView / 2 ||
              slideToIndex >
                s.slides.length - s.loopedSlides + s.params.slidesPerView / 2
            ) {
              s.fixLoop();
    ...
    s.lazy = {
      ...
      loadImageInSlide: function (index, loadInDuplicate) {
        ...
        if (
          slide.hasClass("swiper-lazy") &&
          !slide.hasClass("swiper-lazy-loaded") &&
          !slide.hasClass("swiper-lazy-loading")
        ) {
          img = img.add(slide[0]);
        }
      ...
      load: function () {
        ...
        if (s.params.watchSlidesVisibility) {
          ...
          if (s.params.slidesPerView > 1) {
            for (
              i = s.activeIndex;
              i < s.activeIndex + s.params.slidesPerView;
              i++
            ) {
        ...
        if (s.params.lazyLoadingInPrevNext) {
          if (s.params.slidesPerView > 1) {
            ...
            for (
              i = s.activeIndex + s.params.slidesPerView;
              i <
              s.activeIndex + s.params.slidesPerView + s.params.slidesPerView;
              i++
            ) {
              if (s.slides[i]) s.lazy.loadImageInSlide(i);
            }
