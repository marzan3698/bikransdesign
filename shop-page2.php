<div class="pages">
  <div data-page="shop" class="page no-toolbar no-navbar">
	...
	<?php require_once('navbar.php'); ?>
     ...
     <h2 class="page_title">SHOP PAGE 02</h2>
	...
	<div class="page_single layout_fullwidth_padding">
      ...
      <ul class="shop_items">
          ...
          <li>
          <div class="shop_thumb"><a href="shop-item.php"><img src="images/photos/photo1.jpg" alt="" title="" /></a></div>
          <div class="shop_item_details">
          <h4><a href="shop-item.php">Blue Bike</a></h4>
          ...
          <li>
          <div class="shop_thumb"><a href="shop-item.php"><img src="images/photos/photo2.jpg" alt="" title="" /></a></div>
          <div class="shop_item_details">
          <h4><a href="shop-item.php">Yellow Car</a></h4>
          ...
          <li>
          <div class="shop_thumb"><a href="shop-item.php"><img src="images/photos/photo3.jpg" alt="" title="" /></a></div>
          <div class="shop_item_details">
          <h4><a href="shop-item.php">Summer T-Shirt</a></h4>
          <div class="shop_item_price">$1200</div>
            <div class="item_qnty_shop">
                <form id="myform" method="POST" action="#">
          ...
          <li>
          <div class="shop_thumb"><a href="shop-item.php"><img src="images/photos/photo4.jpg" alt="" title="" /></a></div>
          <div class="shop_item_details">
          <h4><a href="shop-item.php">Valentines Gift</a></h4>
          ...
          <li>
          <div class="shop_thumb"><a href="shop-item.php"><img src="images/photos/photo5.jpg" alt="" title="" /></a></div>
          <div class="shop_item_details">
          <h4><a href="shop-item.php">Rocket Toy</a></h4>
          ...
          <a href="shop.php" class="prev_shop">PREV PAGE</a>
          <span class="shop_pagenr">1/37</span>
          <a href="shop-page2.php" class="next_shop">NEXT PAGE</a>
          </div>
