                    ...
                    <nav class="main-nav"
                        ...
                        <div class="box">
                            <div class="box-text-wrap">
                                <div class="box-text" style="color: white;">প্রোডাক্ট <br> ক্রয় হিসাব</div>
                            </div>
                        ...
                        <table class="table3">
                            <thead>
                                <tr>
                                    <th style="text-align: center; border-right:solid white 1px;" class="dark">ক্রয়
                                        তারিখ </th>
                                    <th class="ash" style="border-right:solid white 1px">মাস</th>
                                    <th class="dark" style="border-right:solid white 1px">পরিমান</th>
                                    <th class="ash">মূল্যে</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
