            ...
            <div data-page="index" class="page homepage" style="background-color: #0B2234 !important;">
                <div class="page-content homepagecontent">
                    ...
                    <nav class="main-nav" style="margin-top: 55px !important; width: 95%; margin: auto;">
                        <div class="box">
                            <div class="box-text-wrap">
                                <div class="box-text" style="color: white;">এজেন্ট প্রোডাক্ট <br> অর্ডার তালিকা</div>
                            </div>
                    ...
                    // ── Pagination config ──────────────────────────────────────────
                        ...
                        $totalRows = QB::table('agent_order')->where('user_id', $_SESSION['user_id'])->count();
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                       ...
                                       <td onclick="window.location.href='order-summary5.php?order_id=<?= $item->id ?>'" style="cursor:pointer;vertical-align: middle;">দেখুন</td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
